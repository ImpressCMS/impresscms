...
define('_IMPRESSCMS_COMMUNITY','Comunità');
...
define('_TOGGLETINY','Attiva/disattiva editor');
...
define("_BLOCK_ID", "ID blocco");
define('_IMPRESSCMS_PROJECT','Sviluppo del progetto');

// added in 1.3.5
define("_FILTERS","Filtri");
define("_FILTER","Filtro");
define("_FILTERS_MSG1","Filtro inserimento: ");
define("_FILTERS_MSG2","Filtro inserimento (HTMLPurifier): ");
define("_FILTERS_MSG3","Filtro output: ");
define("_FILTERS_MSG4","Filtro output (HTMLPurifier): ");


// added in 2.0
define('_ENTER_MENTION', 'Inserire il nome utente da menzionare:');
define( '_ENTER_HASHTAG', 'Inserire i termini da etichettare:');
define('_NAME', 'Nome');
