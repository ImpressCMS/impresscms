...
define("_ER_UP_NOFILEUPLOADED", "Keine Datei hochgeladen");
define("_ER_UP_ERROROCCURRED", "Ein Fehler ist aufgetreten: Fehler Nr.%s");
define("_ER_UP_UPLOADDIRNOTSET", "Upload-Verzeichnis nicht gesetzt");
define("_ER_UP_FAILEDOPENDIR", "Fehler beim Öffnen des Verzeichnises: %s");
define("_ER_UP_FAILEDOPENDIRWRITE", "Fehler beim Öffnen des Verzeichnisses mit Schreibrechten: %s");
define("_ER_UP_FILESIZETOOLARGE", "Dateigröße zu groß (maximal %u Bytes): %u Bytes");
