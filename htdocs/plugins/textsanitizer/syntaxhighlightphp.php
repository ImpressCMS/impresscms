...
function textsanitizer_syntaxhighlightphp(&$ts, &$source, $language )
{
	$source = MyTextSanitizer::undoHtmlSpecialChars($source);
	$source = _textsanitizer_geshi_php_highlight( $source, $language );
	return $source;
}


function _textsanitizer_geshi_php_highlight( $source, $language )
{
