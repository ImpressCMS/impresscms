...
class icms_BootstrapEventHandler
{
    public static function setup()
    {
        ...
        icms_Event::attach('icms', 'finishcoreboot', [__CLASS__, 'finishCoreBoot']);
        icms_Event::attach('icms', '*', [__CLASS__, 'backwardCompatibility']);
    }
    ...
    public static function finishCoreBoot()
    {
     ...
     */
    public static function backwardCompatibility($params, $event)
    {
        if ($event->name == 'startcoreboot') {
            ...
            switch ($params['name']) {
                ...
                case "session":
                    ...
                    $_SESSION['xoopsUserGroups'] = icms::$user ? icms::$user->getGroups() : [ICMS_GROUP_ANONYMOUS];
                    break;
                case "module":
