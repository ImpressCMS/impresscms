...
$valid_op = ['cancel', 'list', 'delete', 'delete_ok', '', null];
$op = 'list';
...
if (in_array($op, $valid_op)) {
    switch ($op) {
        ...
        case 'list':
            ...
            foreach ($notifications as $n) {
                ...
                if ($modid != $prev_modid) {
                    ...
                    $modules[$modid] = ['id' =>$modid, 'name' =>$module->getVar('name'), 'categories' => []];
                ...
                if ($category != $prev_category) {
                    ...
                    $modules[$modid]['categories'][$category] = ['name' =>$category, 'title' => $category_info['title'], 'items' => []];
                }
            ...
            $user_info = ['uid' => icms::$user->getVar('uid')];
        ...
        case 'delete_ok':
            ...
            include ICMS_ROOT_PATH . '/header.php';
            $hidden_vars = ['uid' =>$uid, 'delete_ok' =>1, 'del_not' => $_POST['del_not']];
