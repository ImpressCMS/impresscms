...
FCKMenuBlock.prototype.AddItem = function(
	name,
	label,
...
FCKMenuBlock.prototype.RemoveAllItems = function() {
	...
	if (eItemsTable) {
		while (eItemsTable.rows.length > 0) eItemsTable.deleteRow(0);
	}
};
...
function FCKMenuBlock_Item_OnClick(clickedItem, menuBlock) {
	if (menuBlock.Hide) menuBlock.Hide();
