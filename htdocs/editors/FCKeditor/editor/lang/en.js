...
var FCKLang = {
	...
	FontFormats:
		"Normal;Formatted;Address;Heading 1;Heading 2;Heading 3;Heading 4;Heading 5;Heading 6;Normal (DIV)",
	...
	NotCompatiblePaste:
		"This command is available for Internet Explorer version 5.5 or more. Do you want to paste without cleaning?",
	UnknownToolbarItem: 'Unknown toolbar item "%1"',
	UnknownCommand: 'Unknown command name "%1"',
	NotImplemented: "Command not implemented",
	UnknownToolbarSet: 'Toolbar set "%1" doesn\'t exist',
	NoActiveX:
		'Your browser\'s security settings could limit some features of the editor. You must enable the option "Run ActiveX controls and plug-ins". You may experience errors and notice missing features.',
	BrowseServerBlocked:
		"The resources browser could not be opened. Make sure that all popup blockers are disabled.",
	DialogBlocked:
		"It was not possible to open the dialog window. Make sure all popup blockers are disabled.",
	VisitLinkBlocked:
		"It was not possible to open a new window. Make sure all popup blockers are disabled.",
	...
	DlnLnkMsgInvPopName:
		"The popup name must begin with an alphabetic character and must not contain spaces",
	...
	DlgPasteMsg2:
		"Please paste inside the following box using the keyboard (<strong>Ctrl+V</strong>) and hit <strong>OK</strong>.",
	DlgPasteSec:
	...
	DlgTemplatesSelMsg:
		"Please select the template to open in the editor<br />(the actual contents will be lost):",
