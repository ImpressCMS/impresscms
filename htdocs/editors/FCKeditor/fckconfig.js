...
FCKConfig.PreloadImages = [
	FCKConfig.SkinPath + "images/toolbar.start.gif",
...
FCKConfig.CoreStyles = {
	...
	SelectionHighlight: {
		Element: "span",
		Styles: { "background-color": "navy", color: "white" }
	}
};
...
var _FileBrowserExtension =
	_FileBrowserLanguage == "perl" ? "cgi" : _FileBrowserLanguage;
var _QuickUploadExtension =
	_QuickUploadLanguage == "perl" ? "cgi" : _QuickUploadLanguage;
