...
class TinyMCE
{
     ...
     **/
    public function getElements($element = null)
    {
        static $elements = [];
        if (!empty($element)) {
            $elements[] = $element;
    ...
    public function init()
    {
        ...
        if ($this->setting['theme'] == 'advanced') {
            ...
            $this->setting['theme_advanced_buttons2'] = 'xoopsquote,xoopscode,'
                                                        . (($easiestml_exist)? 'icmsmlcontent,' : '') . 'separator,bullist,numlist,separator,outdent,indent,separator,undo,redo,removeformat,separator,link,unlink,anchor,xoopsimagemanager,media,separator,charmap,nonbreaking,hr,xoopsemotions,separator,pastetext,pasteword,separator,forecolor,backcolor';
