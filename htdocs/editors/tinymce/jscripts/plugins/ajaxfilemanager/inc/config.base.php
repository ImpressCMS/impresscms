...
//error_reporting(E_ALL ^ E_NOTICE);	
	...
	//Modified for ImpressCMS's editor folder location
	define('CONFIG_SYS_DEFAULT_PATH', '../../../uploaded/'); //accept relative path only
	//define('CONFIG_SYS_DEFAULT_PATH', XOOPS_URL.'/editors/tinymce/uploaded/');	//accept relative path only
	
	//define('CONFIG_SYS_ROOT_PATH', '../../../../../../../uploaded/');	//accept relative path only
	//Modified for ImpressCMS's editor folder location
	define('CONFIG_SYS_ROOT_PATH', '../../../uploaded/');	//accept relative path only
	//define('CONFIG_SYS_ROOT_PATH', XOOPS_URL.'/editors/tinymce/uploaded/');	//accept relative path only
