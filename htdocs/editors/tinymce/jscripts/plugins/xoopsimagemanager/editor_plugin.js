...
(function() {
	...
	tinymce.create("tinymce.plugins.XoopsimagemanagerPlugin", {
				...
				ed.windowManager.open(
					{
						...
						width:
							1024 +
							parseInt(
								ed.getLang("xoopsimagemanager.delta_width", 0)
							),
						height:
							730 +
							parseInt(
								ed.getLang("xoopsimagemanager.delta_height", 0)
							),
						inline: 1
					},
					{
		...
		getInfo: function() {
			return {
				...
				infourl:
					"http://wiki.moxiecode.com/index.php/TinyMCE:Plugins/advimage",
	...
	tinymce.PluginManager.add(
		"xoopsimagemanager",
		tinymce.plugins.XoopsimagemanagerPlugin
	);
})();
