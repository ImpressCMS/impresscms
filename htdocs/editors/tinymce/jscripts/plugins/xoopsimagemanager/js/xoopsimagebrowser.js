		...
		if (tinyMCEPopup.getParam("accessibility_warnings", 1)) {
			if (!f.alt.value) {
				tinyMCEPopup.editor.windowManager.confirm(
					tinyMCEPopup.getLang("xoopsimagebrowser_dlg.missing_alt"),
					function(s) {
	...
	showPreviewImage: function(u, st) {
		...
		if (
			...
			tinyMCEPopup.getParam(
				"xoopsimagebrowser_update_dimensions_onchange",
				true
			)
		)
			this.resetImageData();
		...
		if (!st)
			tinyMCEPopup.dom.setHTML(
				...
				'<img id="previewImg" src="' +
					u +
					'" border="0" onload="XoopsimagebrowserDialog.updateImageData(this);" onerror="XoopsimagemanagerDialog.resetImageData();" />'
			);
		else
			tinyMCEPopup.dom.setHTML(
				"prev",
				'<img id="previewImg" src="' +
					u +
					'" border="0" onload="XoopsimagebrowserDialog.updateImageData(this, 1);" />'
			);
	}
};
