...
(function() {
				...
				ed.windowManager.open(
					{
						...
						width:
							460 +
							parseInt(
								ed.getLang("xoopsquotecode.delta_width", 0)
							),
						height:
							300 +
							parseInt(ed.getLang("xoopsquote.delta_height", 0)),
						inline: 1
					},
					{
						plugin_url: url
				...
				ed.windowManager.open(
					{
						...
						width:
							460 +
							parseInt(ed.getLang("xoopscode.delta_width", 0)),
						height:
							300 +
							parseInt(ed.getLang("xoopscode.delta_height", 0)),
						inline: 1
					},
					{
						plugin_url: url
	...
	tinymce.PluginManager.add(
		"xoopsquotecode",
		tinymce.plugins.XoopsquotecodePlugin
	);
})();
