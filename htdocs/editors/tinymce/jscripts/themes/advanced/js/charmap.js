...
function renderCharMapHTML() {
	var charsPerRow = 20,
		...
		i;
	var html =
		'<div id="charmapgroup" aria-labelledby="charmap_label" tabindex="0" role="listbox">' +
	...
	for (i = 0; i < charmap.length; i++) {
		...
		if (charmap[i][2] == true) {
			...
			html +=
				"" +
				'<td class="charmap">' +
				'<a class="charmaplink" role="button" onmouseover="' +
				previewCharFn +
				'" onfocus="' +
				previewCharFn +
				'" href="javascript:void(0)" onclick="insertChar(\'' +
				charmap[i][1].substring(2, charmap[i][1].length - 1) +
				'\');" onclick="return false;" onmousedown="return false;" title="' +
				charmap[i][3] +
				" " +
				tinyMCEPopup.editor.translate("advanced_dlg.charmap_usage") +
				'">' +
				charmap[i][1] +
				"</a></td>";
