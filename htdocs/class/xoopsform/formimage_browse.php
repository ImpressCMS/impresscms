...
function imanager_index($imgcat_id=null){
	...
	if (!empty($catcount)) {
		$form = new icms_form_Theme(_ADDIMAGE, 'image_form', 'formimage_browse.php', 'post', true);
	...
	$form = new icms_form_Theme(_MD_ADDIMGCAT, 'imagecat_form', 'formimage_browse.php', 'post', true);
