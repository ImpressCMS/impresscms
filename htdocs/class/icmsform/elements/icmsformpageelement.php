...
class IcmsFormPageElement extends icms_form_elements_Tray {
	...
	public function __construct($object, $key) {
		...
		$visible_label = new icms_form_elements_Lebel('', '<select name="visiblein[]" id="visiblein[]" multiple="multiple" size="10">'.$this->getPageSelOptions($icms_page_handler, $object->getVar('visiblein')).'</select>');
