<?php
// $Id: xoopslists.php 12329 2013-09-19 13:53:36Z skenow $
//  ------------------------------------------------------------------------ //
 ...
 * @version		$Id: xoopslists.php 12329 2013-09-19 13:53:36Z skenow $
 */



if (defined("ICMS_LISTS_INCLUDED")) {
    exit();
}
...
class IcmsLists
{
    ...
    {
        icms_core_Debug::setDeprecated('icms_core_Filesystem::getFileList', sprintf(_CORE_REMOVE_IN_VERSION, '1.4'));
        return icms_core_Filesystem::getFileList($dirname, $prefix, ['gif', 'jpg', 'png']);
    }
     ...
     */
    public static function getFontListAsArray($dirname, $prefix="")
    {
        icms_core_Debug::setDeprecated('icms_core_Filesystem::getFileList', sprintf(_CORE_REMOVE_IN_VERSION, '1.4'));
        return icms_core_Filesystem::getFileList($dirname, $prefix, ['ttf']);
    }
     ...
     * @todo		Remove in version 1.4 - all occurrences have been removed from the core
     */
    public static function getPhpListAsArray($dirname, $prefix="")
    {
        icms_core_Debug::setDeprecated('icms_core_Filesystem::getFileList', sprintf(_CORE_REMOVE_IN_VERSION, '1.4'));
        $filelist = icms_core_Filesystem::getFileList($dirname, $prefix, ['php']);
    ...
    {
        icms_core_Debug::setDeprecated('icms_core_Filesystem::getFileList', sprintf(_CORE_REMOVE_IN_VERSION, '1.4'));
        return icms_core_Filesystem::getFileList($dirname, $prefix, ['htm', 'html', 'xhtml']);
    }
    ...
    public static function getSubjectsList($sub_dir="")
    {
        ...
        $subjects = [];
        if ($sub_dir != "") {
            $subjects = icms_core_Filesystem::getFileList(ICMS_ROOT_PATH . "/images/subject/" . $sub_dir, $sub_dir . "/", ['gif', 'jpg', 'png']);
        } else {
            $subjects = icms_core_Filesystem::getFileList(ICMS_ROOT_PATH . "/images/subject/", '', ['gif', 'jpg', 'png']);
        }
        return $subjects;
    }
     ...
     * @return array
     */
    public static function getEnabledEditorsList()
    {
    ...
    public static function getUserRankList()
    {
        ...
        return icms_getModuleHandler("userrank", "system")->getList(icms_buildCriteria(["rank_special" => 1]));
    }
}
 ...
 * @deprecated
 */
class XoopsLists extends IcmsLists
