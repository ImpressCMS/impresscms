...
if (!defined("XOOPS_MAINFILE_INCLUDED")) {
	...
	// Example: define( 'XOOPS_ROOT_PATH', '/home/mrtheme/public_html/js' );
	define( 'XOOPS_ROOT_PATH', '/home/mrtheme/public_html/js' );
	...
	// Example: define( 'XOOPS_TRUST_PATH', '/home/mrtheme/trust_paths/js' );
	define( 'XOOPS_TRUST_PATH', '/home/mrtheme/trust_paths/js' );

	include_once XOOPS_TRUST_PATH . '/91259163d7b99474fbaf55759efaeeba.php' ;

	// XOOPS Virtual Path (URL)
	// Virtual path to your main XOOPS directory WITHOUT trailing slash
	// Example: define( 'XOOPS_URL', 'http://mrtheme.com/js' );
	define( 'XOOPS_URL', 'http://mrtheme.com/js' );
