...
if (!defined("XOOPS_MAINFILE_INCLUDED")) {
	...
	// Example: define( 'XOOPS_ROOT_PATH', '/vagrant/impresscms/htdocs' );
	define( 'XOOPS_ROOT_PATH', '/vagrant/impresscms/htdocs' );
	...
	// Example: define( 'XOOPS_TRUST_PATH', '/vagrant/impresscms/565e898fe6a2170' );
	define( 'XOOPS_TRUST_PATH', '/vagrant/impresscms/565e898fe6a2170' );

	include_once XOOPS_TRUST_PATH . '/71fb07e3c0b0b98a51b22a004c877b3b.php' ;

	// XOOPS Virtual Path (URL)
	// Virtual path to your main XOOPS directory WITHOUT trailing slash
	// Example: define( 'XOOPS_URL', 'http://localhost:8800' );
	define( 'XOOPS_URL', 'http://localhost:8800' );
