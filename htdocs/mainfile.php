...
if (!defined("XOOPS_MAINFILE_INCLUDED")) {
	...
	// Example: define( 'XOOPS_ROOT_PATH', '/home/marcan/dev/impresscms_trunk/htdocs' );
	define( 'XOOPS_ROOT_PATH', '/home/marcan/dev/impresscms_trunk/htdocs' );
	...
	// Example: define( 'XOOPS_TRUST_PATH', '/home/marcan/dev/impresscms_trunk/trust_path' );
	define( 'XOOPS_TRUST_PATH', '/home/marcan/dev/impresscms_trunk/trust_path' );

	include_once XOOPS_TRUST_PATH . '/f425fdd799605247b56223b32039065c.php' ;

	// XOOPS Virtual Path (URL)
	// Virtual path to your main XOOPS directory WITHOUT trailing slash
	// Example: define( 'XOOPS_URL', 'http://inbox2.local/impresscms_trunk/htdocs' );
	define( 'XOOPS_URL', 'http://inbox2.local/impresscms_trunk/htdocs' );
