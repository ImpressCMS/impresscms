...
if ( !defined("XOOPS_MAINFILE_INCLUDED") ) {
	...
	// Example: define( 'XOOPS_ROOT_PATH', 'C:/xampp/htdocs/icmstrunk/htdocs' );
	define( 'XOOPS_ROOT_PATH', 'C:/xampp/htdocs/icmstrunk/htdocs' );
	...
	// Example: define( 'XOOPS_TRUST_PATH', 'C:/xampp/trust_pathdafe5' );
	define( 'XOOPS_TRUST_PATH', 'C:/xampp/trust_pathdafe5' );

	include_once(XOOPS_TRUST_PATH . '/e19c90768f2880cab2e9cf7a00c82b3f.php');

	// XOOPS Virtual Path (URL)
	// Virtual path to your main XOOPS directory WITHOUT trailing slash
	// Example: define( 'XOOPS_URL', 'http://localhost/icmstrunk/htdocs' );
	define( 'XOOPS_URL', 'http://localhost/icmstrunk/htdocs' );
