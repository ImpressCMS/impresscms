...
$xoopsTpl->assign("content_tinfo", sprintf(_CT_PUBLISHEDBY.' <a href="'.XOOPS_URL.'/userinfo.php?uid=%u">%s</a> '._CT_ON.' %s (%u reads)',$autor->getVar('uid'),$autor->getVar('uname'),date('d/m/Y',$impress_content->getVar('content_created')),$impress_content->getReads()));
