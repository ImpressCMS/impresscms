...
* @version		$Id: pmlite.php 11457 2011-11-25 23:00:05Z skenow $
*/
...
if ($icmsUser) {
    ...
    if (isset($_POST['op']) && $_POST['op'] == "submit") {
        ...
        if ($count != 1) {
            ...
            $pm->setVar("subject", $myts->displayTarea($_POST['subject'], FALSE, FALSE, FALSE, FALSE, FALSE));
            $pm->setVar("msg_text", $myts->displayTarea($_POST['message'], TRUE, FALSE, FALSE, FALSE, FALSE));
