...
function icms_cp_header()
{
    ...
    $icmsTheme = $xoTheme =& $xoopsThemeFactory->createInstance([
    ...
    $xoTheme->addScript('', ['type' => 'text/javascript'], 'startList = function() {
    ...
    $xoTheme->addStylesheet(ICMS_URL . '/icms' . ((defined('_ADM_USE_RTL') && _ADM_USE_RTL) ? '_rtl' : '') . '.css', ['media' => 'screen']);

    // JQuery UI Dialog
    $xoTheme->addScript(ICMS_URL . '/libraries/jquery/jquery.js', ['type' => 'text/javascript']);
    if (! empty($_SESSION['redirect_message'])) {
        $xoTheme->addScript(ICMS_URL.'/libraries/jquery/jgrowl.js', ['type' => 'text/javascript']);
        $xoTheme->addStylesheet(ICMS_URL.'/libraries/jquery/jgrowl'.((defined('_ADM_USE_RTL') && _ADM_USE_RTL)?'_rtl':'').'.css', ['media' => 'screen']);
    ...
    $xoTheme->addScript(ICMS_URL . '/libraries/jquery/ui/ui.min.js', ['type' => 'text/javascript']);
    $xoTheme->addScript(ICMS_URL . '/libraries/jquery/helptip.js', ['type' => 'text/javascript']);
    $xoTheme->addStylesheet(ICMS_URL . '/libraries/jquery/ui/css/ui-smoothness/ui.css', ['media' => 'screen']);
