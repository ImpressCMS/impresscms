...
//*****************************************************//
if (tipo != 1) var margin = '0px; margin-top:3px;'; else var margin = '10px;';
...
txt+='<layer name="perdone" width="'+(barwidth-2)+'" height="'+(barheight-2)+'" bgcolor="green" top="1" left="1"></layer>';
txt+='<layer name="perouter1" style="position:relative; float:left; background:transparent; width:100px; height:'+barheight+'px; margin-left:10px; padding:5px; margin-bottom:-10px; font-weight:bold; color:'+ratingMsgColors[0]+'; font-size:12px; text-align:left;"></layer>';
txt+='</ilayer>';
txt+='</td></tr></table>';
}else{
txt+='<div id="perouter" onmouseup="hidebar()" style="position:relative; float:left; visibility:hidden; background-color:'+bordercolor+'; width:'+barwidth+'px; height:'+barheight+'px; margin-left:'+margin+'">';
...
txt+='<div id="perdone" style="position:absolute; top:1px; left:1px; width:0px; height:'+(barheight-2)+'px; background-color:green; z-index:100; font-size:1px;"></div>';
txt+='</div>';
txt+='<div id="perouter1" style="position:relative; float:left; background:transparent; width:100px; height:'+barheight+'px; margin-left:10px; padding:5px; margin-bottom:-10px; font-weight:bold; color:'+ratingMsgColors[0]+'; font-size:12px; text-align:left;"></div>';
}
