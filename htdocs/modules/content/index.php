...
$xoopsTpl->assign('content_contents', $content_content_handler->getContents($clean_start, $xoopsModuleConfig['contents_limit'], $clean_content_uid, $clean_content_tags, false, $clean_content_pid));
...
$pagenav = new XoopsPageNav($contents_count, $xoopsModuleConfig['contents_limit'], $clean_start, 'start', $extr_arg);
$xoopsTpl->assign('navbar', $pagenav->renderNav());

$xoopsTpl->assign('content_module_home', content_getModuleName(true, true));
if ($clean_content_uid) {
	$xoopsTpl->assign('content_category_path', sprintf(_CO_CONTENT_CONTENT_FROM_USER, icms_getLinkedUnameFromId($clean_content_uid)));
}
