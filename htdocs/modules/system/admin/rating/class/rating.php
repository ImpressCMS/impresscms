...
class SystemRating extends icms_ipf_Object
{
    ...
    public function __construct(&$handler)
    {
        ...
        $this->setControl('dirname', ['method' => 'getModuleList', 'onSelect' => 'submit']);
        $this->setControl('item', ['object' => &$this, 'method' => 'getItemList']);
        $this->setControl('uid', 'user');
        $this->setControl('rate', ['method' => 'getRateList']);
    }
    ...
    {
        return icms_member_user_Handler::getUserLink($this->getVar('uid', 'e'), true, []);
    }
