...
if (!is_object(icms::$user) || !is_object($icmsModule) || !icms::$user->isAdmin($icmsModule->getVar('mid'))) {
    ...
    if ($op == 'addfile') {
        ...
        $uploader = new icms_file_MediaUploadHandler(ICMS_UPLOAD_PATH, ['image/gif', 'image/jpeg', 'image/pjpeg', 'image/x-png', 'image/png'], $icmsConfigUser['avatar_maxsize'], $icmsConfigUser['avatar_width'], $icmsConfigUser['avatar_height']);
    ...
    if ($op == 'delfile') {
        ...
        icms_core_Message::confirm(['op' => 'delfileok', 'avatar_id' => (int) ($_GET['avatar_id']), 'fct' => 'avatars', 'user_id' => $user_id], 'admin.php', _MD_RUDELIMG);
        icms_cp_footer();
        exit();
    }
