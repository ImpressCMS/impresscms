...
if (in_array($op, ['submit', 'install_ok', 'update_ok', 'uninstall_ok'])) {
...
if ($op == 'install') {
    ...
    icms_cp_header();
    icms_core_Message::confirm(['module' => $module, 'op' => 'install_ok', 'fct' => 'modulesadmin', 'from_112' => $from_112], 'admin.php', $msgs, _MD_AM_INSTALL);
    icms_cp_footer();
    exit();
}
...
if ($op == 'uninstall') {
    ...
    icms_cp_header();
    icms_core_Message::confirm(['module' => $module, 'op' => 'uninstall_ok', 'fct' => 'modulesadmin'], 'admin.php', $msgs, _YES);
    icms_cp_footer();
    exit();
}
...
if ($op == 'update') {
    ...
    icms_core_Message::confirm(['module' => $module, 'op' => 'update_ok', 'fct' => 'modulesadmin'], 'admin.php', $msgs, _MD_AM_UPDATE);
    icms_cp_footer();
    exit();
}
