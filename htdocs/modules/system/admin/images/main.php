...
switch ($op) {
    ...
    case 'delcat':
        icms_cp_header();
        icms_core_Message::confirm(['op' => 'delcatok', 'imgcat_id' => $imgcat_id, 'fct' => 'images'], 'admin.php', _MD_RUDELIMGCAT);
        icms_cp_footer();
        break;
    ...
    case 'delfile':
        ...
        icms_core_Message::confirm(['op' => 'delfileok', 'image_id' => $image_id, 'imgcat_id' => $imgcat_id, 'fct' => 'images'], 'admin.php', _MD_RUDELIMG);
        icms_cp_footer();
        break;
...
function imanager_index($imgcat_id = null)
{
    ...
    $storetype->addOptionArray(['file' => sprintf(_MD_ASFILE, str_ireplace(ICMS_ROOT_PATH, '', ICMS_IMANAGER_FOLDER_PATH) . '/foldername'), 'db' => _MD_INDB]);
...
function imanager_listimg($imgcat_id, $start = 0)
{
    ...
    foreach (array_keys($images) as $i) {
        ...
        $extra_perm = ["image/jpeg", "image/jpeg", "image/png", "image/gif"];
        ...
        $list = $imgcat_handler->getList([], null, null, $imagecategory->getVar('imgcat_storetype'));
        $div = '';
...
function imanager_editcat($imgcat_id)
{
    ...
    $storetype = ['db' => _MD_INDB, 'file' => sprintf(_MD_ASFILE, str_ireplace(ICMS_ROOT_PATH, '', $imgcat_handler->getCategFolder($imagecategory)))];
...
function imanager_addfile()
{
    ...
    $uploader = new icms_file_MediaUploadHandler($updir, ['image/gif', 'image/jpeg', 'image/pjpeg', 'image/x-png', 'image/png', 'image/bmp'], $imagecategory->getVar('imgcat_maxsize'), $imagecategory->getVar('imgcat_maxwidth'), $imagecategory->getVar('imgcat_maxheight'));
