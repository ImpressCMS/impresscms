...
switch ($op) {
    ...
    case 'delfile':
        ...
        icms_core_Message::confirm(['op' => 'delfileok', 'image_id' => $image_id, 'imgcat_id' => $imgcat_id, 'target' => $target, 'type' => $type], 'browser.php', _MD_RUDELIMG);
        icmsPopupFooter();
        break;
...
function imanager_clone()
{
    ...
    redirect_header('browser.php' . $redir, 2, $msg);
}
