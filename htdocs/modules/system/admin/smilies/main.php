...
switch ($op) {
    ...
    case "SmilesAdd":
        ...
        $db = icms_db_Factory::instance();
        $uploader = new icms_file_MediaUploadHandler(ICMS_UPLOAD_PATH, ['image/gif', 'image/jpeg', 'image/pjpeg', 'image/x-png'], 100000, 120, 120);
    ...
    case "SmilesDel":
        ...
        if ($id > 0) {
            icms_cp_header();
            icms_core_Message::confirm(['fct' => 'smilies', 'op' => 'SmilesDelOk', 'id' => $id], 'admin.php', _AM_WAYSYWTDTS);
            icms_cp_footer();
        }
        break;
