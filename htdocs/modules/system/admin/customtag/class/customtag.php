...
class SystemCustomtag extends IcmsPersistableObject {
    ...
    function SystemCustomtag() {
        ...
        $this->setControl('language', array('name' => 'language',
        								'all' => true));
		$this->setControl('customtag_type', array('itemHandler' => 'customtag',
                                  'method' => 'getCustomtag_types',
                                  'module' => 'system'));
    }
...
class SystemCustomtagHandler extends IcmsPersistableObjectHandler {
	...
	function getCustomtag_types() {
		$ret = array(
			ICMS_CUSTOMTAG_TYPE_XCODES => 'XCodes',
			ICMS_CUSTOMTAG_TYPE_HTML => 'HTML',
			ICMS_CUSTOMTAG_TYPE_PHP => 'PHP'
		);	
		return $ret;
	}
}
