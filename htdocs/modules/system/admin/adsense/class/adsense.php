...
class SystemAdsense extends icms_ipf_Object
{
    ...
    public function __construct(&$handler)
    {
        ...
        $this->setControl('format', ['method' => 'getFormats']);
    ...
    {
        if ($format == 's' && in_array($key, ["color_border", "color_background", "color_link", "color_url", "color_text"])) {
    ...
    public function generateTag()
    {
        ...
        $tableau = array_filter($tableau, [$this, "emptyString"]);
