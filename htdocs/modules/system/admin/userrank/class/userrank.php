...
class SystemUserrankHandler extends icms_ipf_Handler
{
    ...
    public function __construct($db)
    {
        ...
        $this->enableUpload(["image/gif", "image/jpeg", "image/pjpeg", "image/x-png", "image/png"], $icmsConfigUser["rank_maxsize"], $icmsConfigUser["rank_width"], $icmsConfigUser["rank_height"]);
    }
