 ...
 */
    ...
    if ($dbVersion < $newDbVersion) {
        ...
        $icmsDatabaseUpdater->insertConfig(ICMS_CONF_CAPTCHA, 'captcha_skipmember', '_MD_AM_CAPTCHA_SKIPMEMBER', serialize(['2']), '_MD_AM_CAPTCHA_SKIPMEMBERDSC', 'group_multi', 'array', 2);
        ...
        $icmsDatabaseUpdater->insertConfig(ICMS_CONF_CAPTCHA, 'captcha_skip_characters', '_MD_AM_CAPTCHA_SKIPCHAR', serialize(['o', '0', 'i', 'l', '1']), '_MD_AM_CAPTCHA_SKIPCHARDSC', 'textarea', 'array', 4);
    ...
    if ($dbVersion < $newDbVersion) {
        ...
        $icmsDatabaseUpdater->insertConfig(ICMS_CONF_PLUGINS, 'sanitizer_plugins', '_MD_AM_SELECTSPLUGINS', serialize(['']), '_MD_AM_SELECTSPLUGINS_DESC', 'select_plugin', 'array', 1);
...
*/
    ...
    if ($dbVersion < $newDbVersion) {
        ...
        $icmsDatabaseUpdater->insertConfig(ICMS_CONF_PURIFIER, 'purifier_URI_AllowedSchemes', '_MD_AM_PURIFIER_URI_ALLOWSCHEME', serialize(['http', 'https', 'mailto', 'ftp', 'nntp', 'news']), '_MD_AM_PURIFIER_URI_ALLOWSCHEMEDSC', 'textsarea', 'array', $p++);
        ...
        $icmsDatabaseUpdater->insertConfig(ICMS_CONF_PURIFIER, 'purifier_Core_HiddenElements', '_MD_AM_PURIFIER_CORE_HIDDENELE', serialize(['script', 'style']), '_MD_AM_PURIFIER_CORE_HIDDENELEDSC', 'textsarea', 'array', $p++);
        ...
        $icmsDatabaseUpdater->insertConfig(ICMS_CONF_PURIFIER, 'purifier_AutoFormat_RemoveEmptyNbspExceptions', '_MD_AM_PURIFIER_AUTO_REMOVEEMPTYNBSPEXCEPT', serialize(['td', 'th']), '_MD_AM_PURIFIER_AUTO_REMOVEEMPTYNBSPEXCEPTDSC', 'textsarea', 'array', $p++);

        $icmsDatabaseUpdater->insertConfig(ICMS_CONF_PURIFIER, 'purifier_Attr_AllowedFrameTargets', '_MD_AM_PURIFIER_ATTR_ALLOWFRAMETARGET', serialize(['_blank', '_parent', '_self', '_top']), '_MD_AM_PURIFIER_ATTR_ALLOWFRAMETARGETDSC', 'textsarea', 'array', $p++);
        $icmsDatabaseUpdater->insertConfig(ICMS_CONF_PURIFIER, 'purifier_Attr_AllowedRel', '_MD_AM_PURIFIER_ATTR_ALLOWREL', serialize(['external', 'nofollow', 'external nofollow', 'lightbox']), '_MD_AM_PURIFIER_ATTR_ALLOWRELDSC', 'textsarea', 'array', $p++);
    ...
    /* The admin control panel now consists of blocks - these need to be set as visible
         ...
         */
    if ($dbVersion < $newDbVersion) {
        $admin_blocks = [['b_system_admin_cp_show', 'page_topleft_admin'], ['b_system_admin_modules_show', 'page_topright_admin'], ['b_system_admin_warnings_show', 'page_topcenter_admin']];
        /* Get block positions */
