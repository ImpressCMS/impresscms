...
function b_social_bookmarks(){
    global $xoopsConfig;
$bookmark ="
<div style=\"border-top-style:solid; padding-top:3px; border-top-width: 1px; border-top-color: #2A4956; float: "._GLOBAL_LEFT.";\">
...
$bookmark .="
<div style=\" border-top-color: #2A4956; float: "._GLOBAL_LEFT.";\">";
