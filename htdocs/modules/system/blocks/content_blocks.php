...
/**
* Shows edit form for the content
*
* @param array $options The array of options
* @return string $form The generated form HTML string
*/
...
/**
* Shows the menu with related options
*
* @param array $options The array of options
...
/**
* Shows edit options for related content menu
*
* @param array $options The array of options
* @return string $form The generated form HTML string
*/
...
/**
* Gets the content tag menu
*
* @param array $options Options for the tag menu
