...
define('_MD_AM_PERMADDNG', 'Impossible d\'ajouter la permission: %s au groupe: %s)');
define('_MD_AM_PERMADDOK', 'La permission: %s au groupe: %s a &eacute;t&eacute; ajout&eacute;e avec succ&egrave;s');
