<?php
// fichier:  .../modules/system/admin/groups/groups.php
//             .../modules/system/admin/groups/groupform.php
//Gestion/ modification des groupes d'utilisateurs
// Attention ! ce Code  %s  est  le nom du groupes.
