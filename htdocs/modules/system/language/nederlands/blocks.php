...
define('_MB_SYSTEM_HOME', 'Startpagina');
// link to home page in main menu block
...
define('_MB_SYSTEM_LOGO', 'Logo afbeelding in de %s map');
// %s is your root image directory name
...
// openid
define('_MB_SYSTEM_OPENID_LOGIN', 'Login/Registreer met OpenID');
define('_MB_SYSTEM_OPENID_URL', 'Uw OpenID URL:');
define('_MB_SYSTEM_OPENID_NORMAL_LOGIN', 'Terug naar standaard login');
...
define('_MB_SYSTEM_SOCIAL_PROVIDER_3', 'Delicious');
