...
define('_AM_SBLEFT_ADMIN', 'Admin Zijblok - links');
define('_AM_SBRIGHT_ADMIN', 'Admin Zijblok - rechts');
define('_AM_CBLEFT_ADMIN', 'Admin Middenblok - links');
define('_AM_CBRIGHT_ADMIN', 'Admin Middenblok - rechts');
define('_AM_CBCENTER_ADMIN', 'Admin Middenblok - midden');
