...
if (!defined('_CT_EDIT_CONTENT')) {
    define('_CT_EDIT_CONTENT', 'Modifica contenuto');
}
if (!defined('_CT_DELETE_CONTENT')) {
    define('_CT_DELETE_CONTENT', 'Elimina contenuto');
}
if (!defined('_CT_PUBLISHEDBY')) {
    define('_CT_PUBLISHEDBY', 'Inviato da');
}
if (!defined('_CT_READS')) {
    define('_CT_READS', 'letture');
}
if (!defined('_CT_ON')) {
    define('_CT_ON', 'il');
}
