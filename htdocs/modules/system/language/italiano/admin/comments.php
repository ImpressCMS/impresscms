...
//%%%%%% Comment Manager %%%%%
define('_MD_AM_COMMMAN','Amministrazione Commenti');

define('_MD_AM_LISTCOMM','Lista dei commenti');
define('_MD_AM_ALLMODS','Tutti i moduli');
define('_MD_AM_ALLSTATUS','Qualsiasi stato');
define('_MD_AM_MODULE','Modulo');
define('_MD_AM_COMFOUND','Presenti %s commenti.');
// Added in 1.3
define('_MD_AM_ACTION', 'Azioni');
define('_MD_AM_MESSAGE_ICON', 'Icona');