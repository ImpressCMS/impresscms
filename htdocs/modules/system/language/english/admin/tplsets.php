...
define("_MD_TPLSET_CREATE_OWN", "In order to modify templates online, please create a clone of the <stong>default</strong> template set or upload your own template set package.");