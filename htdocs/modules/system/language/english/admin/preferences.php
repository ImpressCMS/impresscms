...
define("_MD_AM_LOGOADM","Admin Logo");
define("_MD_AM_LOGOADM_DESC"," URL for admin logo. <br /><b> Maximum size:</b><br />  Width  170x. <br /> Height : 80px.<br /><b><i> To select or send an image create at least one image cateory under system --> images.</b></i> ");
