...
define("_MD_AM_EMAILPROTECT"," Truncating url\'s?");
define("_MD_AM_EMAILPROTECTDSC","By selecting \"Yes\" all url&links committed in your site will have a shorter length");
define("_MD_AM_EMAILLEN","Max Length");
define("_MD_AM_EMAILLEN_DESC","The maximum amount of characteres to be ignored for truncating, url\'s larger than this will be shorten.");
define("_MD_AM_SOMBRAX","Pre Characters");
define("_MD_AM_SOMBRAX_DESC","How many characteres do you want to be shown in begin of truncated url\'s.");
define("_MD_AM_SOMBRAY","Last Characters");
define("_MD_AM_SOMBRAY_DESC","How many characteres do you want to be shown at the end of truncated url\'s.");
/*
