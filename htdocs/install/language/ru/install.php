...
// Buttons
define("BUTTON_PREVIOUS", "<< Пред."); // L42
define("BUTTON_NEXT", "След. >>"); // L47
define("BUTTON_FINISH", "Завершить");
define("BUTTON_REFRESH", "Обновить");
...
define("_INSTALL_LOCAL_SITE", 'http://www.impresscms.ru/'); //Link to local support site
