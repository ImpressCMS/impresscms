...
define("NO_PHP5_CONTENT", "PHP 7.4 &egrave; indispensabile per il buon funzionamento di ImpressCMS (PHP 8.3 è consigliato) - La tua insallazione non pu&ograve; continuare. Sei pregato di chiedere al tuo amministratore del serveer di aggiornare l'ambiente almeno a PHP 7.4 - 8.3 fortemente consigliato prima di provare a installare ancora. ");
