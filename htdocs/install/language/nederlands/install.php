...
define("NO_PHP5_TITLE", "Geen PHP 7.4" );
define("NO_PHP5_CONTENT", "PHP 7.4 is minimaal vereist (PHP 8.3 is sterk aanbevolen) om ImpressCMS correct te laten werken. De installatie kan niet verder gaan. Contacteer aub uw hosting aanbieder om uw PHP te upgraden naar een versie die nieuwer is dan 7.4 (PHP 8.3 is sterk aanbevolen) vooraleer de installatie opnieuw op te starten." );
