...
define(
	"ALTERNATE_LANGUAGE_MSG",
	"Download an alternate language pack from the ImpressCMS website",
);
define(
	"ALTERNATE_LANGUAGE_LNK_MSG",
	"Select another language not listed here.",
);
define(
	"ALTERNATE_LANGUAGE_LNK_URL",
	"https://sourceforge.net/projects/impresscms/files/ImpressCMS%20Languages/",
);
...
define(
	...
	"Copyright &copy; 2007-" .
		date("Y", time()) .
		" <a href=\"https://www.impresscms.org\" target=\"_blank\">The ImpressCMS Project</a>",
);
...
define(
	"INTRODUCTION_TITLE",
	"Welcome to the ImpressCMS installation assistant",
); // L0
...
define(
	"NO_PHP5_CONTENT",
	"PHP 7.4.0 minimum is required (PHP 8.3 is recommended) for ImpressCMS to function properly - your installation cannot continue. Please work with your hosting provider to upgrade your environment to a version of PHP that is newer than 7.4.0 (8.3 is recommended) before attempting to install again.",
);
define("SAFE_MODE", "Safe Mode On");
define("SAFE_MODE_TITLE", "Safe Mode On");
define(
	"SAFE_MODE_CONTENT",
	"ImpressCMS has detected PHP is running in Safe Mode. Because of this, your installation cannot continue. Please work with your hosting provider to change your environment before attempting to install again.",
);
...
define(
	"DB_NAME_HELP",
	"The name of database on the host. The installer will attempt to create a database if one does not exist",
); // L64
define(
	"DB_CHARSET_LABEL",
	"Database character set, we STRONGLY recommend you to use UTF-8 as default.",
);
define(
	"DB_CHARSET_HELP",
...
define(
	"DB_SALT_HELP",
	"This salt key will be appended to passwords in function icms_encryptPass(), and is used to create a totally unique secure password. Do Not change this key once your site is live, doing so will render ALL passwords invalid. If you are unsure, just keep the default",
); // L97
...
define(
	"READY_CREATE_TABLES",
	"No ImpressCMS tables were detected.<br />The installer is now ready to create the ImpressCMS system tables.<br />Press <em>next</em> to proceed.",
);
define(
	"XOOPS_TABLES_FOUND",
	"The ImpressCMS system tables already exists in your database.<br />Press <em>next</em> to go to the next step.",
); // L131
define(
	"READY_INSERT_DATA",
...
define(
	...
	"ImpressCMS data is stored in your database already. No further data will be stored by this action.<br />Press <em>next</em> to go to the next step.",
);
...
define(
	"ERR_NO_XOOPS_FOUND",
	"No ImpressCMS installation could be found in the specified folder.",
);
...
define(
	...
	"The server must be given write access to the following files and folders<br />(i.e. <em>chmod 777 directory_name</em> on a UNIX/LINUX server)",
); // L72
define(
	"ERR_NO_DATABASE",
...
define(
	"ERR_WRITE_SDATA",
	"Could not write into sdata.php. Please check the file permission and try again.",
);
...
define(
	"ERR_CHARSET_NOT_SET",
	"Default character set is not set for ImpressCMS database.",
);

//
define(
	"_INSTALL_SELECT_MODS_INTRO",
	'From the list below, please select the modules that you wish to install on this site. <br /><br />
...
define(
	"_INSTALL_SELECT_MODULES_ANON_VISIBLE",
	"Select modules visible to visitors",
);
define("_INSTALL_IMPOSSIBLE_MOD_INSTALL", "Module %s could not be installed.");
define("_INSTALL_ERRORS", "Errors");
define(
	"_INSTALL_MOD_ALREADY_INSTALLED",
	"Module %s has already been installed",
);
define("_INSTALL_FAILED_TO_EXECUTE", "Failed to execute ");
define("_INSTALL_EXECUTED_SUCCESSFULLY", "Executed correctly");

define(
	"_INSTALL_MOD_INSTALL_SUCCESSFULLY",
	"Module %s has been installed succesfully.",
);
define(
	"_INSTALL_MOD_INSTALL_FAILED",
	"The wizard could not install module %s.",
);
define(
	"_INSTALL_NO_PLUS_MOD",
	"No modules were selected for installation. Please continue the installation by clicking next.",
);
...
define(
	"_INSTALL_COULD_NOT_INSERT",
	"The wizard was unable to install module %s the database.",
);
...
define(
	"TRUST_PATH_VALIDATE",
	"A suggested name for the Trust path has been created above for you. If you wish to use an alternative name, please replace the above location with your choice of name.<br /><br />When done, please click on the Create Trust Path button.",
);
define(
	"TRUST_PATH_NEED_CREATED_MANUALLY",
	"It was not possible to create the trust path. Please create it manually and click on the following Refresh button.",
);
define("BUTTON_CREATE_TUST_PATH", "Create Trust Path");
define(
	"TRUST_PATH_SUCCESSFULLY_CREATED",
	"The trust path was successfully created.",
);
...
define(
	"_MD_AM_MULTLOGINMSG_TXT",
	'It was not possible to login on the site!! <br />
...
define(
	"_MD_AM_RSSLOCALLINK_DESC",
	"https://www.impresscms.org/modules/news/rss.php",
); //Link to the rrs of local support site
...
define(
	"_LOCAL_FOOTER",
	"Powered by ImpressCMS &copy; 2007-" .
		date("Y", time()) .
		' <a href=\"https://www.impresscms.org/\" rel=\"external\">The ImpressCMS Project</a>',
); //footer Link to local support site
...
define(
	"DB_PCONNECT_HELP",
	"Persistent connections are useful with slower internet connections. They are not generally required for most installations. Default is 'NO'. Choose 'NO' if you are unsure",
); // L69
define(
	"DB_PCONNECT_HELPS",
	"Persistent connections are useful with slower internet connections. They are not generally required for most installations.",
); // L69

// Added in 1.3
define("FILE_PERMISSIONS", "File Permissions");

// Vendor move page (added for trust-path security feature)
define("MOVE_VENDOR", "Vendor setup");
define("MOVE_VENDOR_TITLE", "Moving vendor libraries to trust path");
define(
	"VENDOR_MOVE_INTRO",
	"ImpressCMS will now move the Composer <code>vendor</code> directory from the web-accessible root to your secure trust path. This prevents direct web access to third-party library files and is strongly recommended on shared hosting.",
);
define(
	"VENDOR_MOVE_READY",
	"The <code>vendor</code> directory will be moved from the web root to your trust path. Click <em>Next</em> to proceed.",
);
define(
	"VENDOR_ALREADY_IN_TRUST",
	"The <code>vendor</code> directory is already located in the trust path. No action is required; click <em>Next</em> to continue.",
);
define(
	"VENDOR_MOVE_CONFLICT",
	"A <code>vendor</code> directory already exists in the trust path with different contents. Clicking <em>Next</em> will replace it with the version from the web root.",
);
define(
	"VENDOR_MOVE_NOT_FOUND",
	"<strong>Warning:</strong> No <code>vendor</code> directory was found in the web root or the trust path. The application may not function correctly. If you extracted the archive correctly, please verify that the <code>vendor</code> folder is present in your web root, then return to the previous step and try again.",
);
define(
	"VENDOR_MOVE_SUCCESS",
	"The <code>vendor</code> directory was successfully moved to the trust path.",
);
define(
	"VENDOR_MOVE_FAILED_COPY",
	"Could not copy the <code>vendor</code> directory from <code>%s</code> to <code>%s</code>. Please check that the trust path is writable and that the server has sufficient disk space, then try again.",
);
define(
	"VENDOR_MOVE_DELETE_WARN",
	"<strong>Note:</strong> The original <code>vendor</code> directory at <code>%s</code> could not be deleted automatically. For security, please remove it manually via FTP/SFTP after installation completes.",
);
define(
	"VENDOR_MOVE_MANUAL_INSTRUCTIONS",
	"<strong>Manual remediation steps:</strong><ol><li>Connect to your server via FTP or SFTP.</li><li>Move the entire <code>vendor</code> folder from your web root (where <code>index.php</code> lives) into your trust path folder.</li><li>The result should be: <code>&lt;your-trust-path&gt;/vendor/autoload.php</code></li><li>Return here and click <em>Next</em> to continue the installation.</li></ol>",
);
define(
	"VENDOR_MOVE_SESSION_ERROR",
	"Could not read the installation paths from the session. Please go back to the <em>Paths settings</em> step and verify your settings.",
);
