Welcome to your new ImpressCMS powered website. If you haven't already please delete the [b]install[/b] folder from the server and ensure that [b]mainfile.php[/b] is not writable (chmod 444).
...
You will also need to begin using [b]Blocks[/b]. You can begin by removing this block. Block administration is located under the System drop down in the administration area.
...
We warmly invite you to join [url=http://community.imprescms.org]The ImpressCMS Community[/url] where you will be able to participate to this great project, post questions, get hep, help others. etc...