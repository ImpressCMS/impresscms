...
define("BUTTON_REFRESH", "Refrescar");
...
define("_INSTALL_ERRORS", 'Errores');
...
define("_INSTALL_CHARSET", "u-8");

define("_INSTALL_PHYSICAL_PATH", "Physical path");

define("_MD_AM_MULTLOGINMSG_TXT", 'No fue posible iniciar sesión en el sitio!! <br />
