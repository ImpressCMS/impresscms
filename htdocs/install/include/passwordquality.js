...
function initQualityMeter(change){
	updateQualityMeter();
	document.getElementById('adminpass').onkeyup = updateQualityMeter;
}
...
function getPasswordStrength(){
    ...
    var regex1 = document.getElementById('regex1').value;
    var regex2 = document.getElementById('regex2').value;
    var regex3 = document.getElementById('regex3').value;
    var regex4 = document.getElementById('regex4').value;
    var regex5 = document.getElementById('regex5').value;
