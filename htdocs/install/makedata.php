...
function make_data(&$dbm, &$cm, $adminname, $adminpass, $adminmail, $language, $groups){
    ...
    $dbm->insert('config', " VALUES (15, 0, 2, 'remember_me', '_MD_AM_REMEMBERME', '0', '_MD_AM_REMEMBERMEDSC', 'yesno', 'int', 30)");
	...
	$dbm->insert('config', " VALUES (100, 0, 8,'ml_captions', '_MD_AM_ML_CAPTIONS', 'English,Fran�ais', '_MD_AM_ML_CAPTIONS_DESC', 'textbox', 'text', 15)");
