...
*/
	...
	$i++;
	$p++;
	$dbm->insert('config', " VALUES ($i, 0, $c, 'use_hidden', '_MD_AM_HIDDENCONTENT', '1', '_MD_AM_HIDDENCONTENTDSC', 'yesno', 'int', $p)");
	$i++;
	$p++;
    ...
    $dbm->insert('config', " VALUES ($i, 0, $c, 'autotasks_user', '_MD_AM_AUTOTASKS_USER', '', '_MD_AM_AUTOTASKS_USERDSC', 'text', 'text', $p)");
     ...
     $i++;
     $p++;
     $dbm->insert('config', " VALUES ($i, 0, $c, 'purifier_Filter_ExtractStyleBlocks_Scope', '_MD_AM_PURIFIER_FILTER_EXTRACTSTYLEBLKSCOPE', 'cssuser_', '_MD_AM_PURIFIER_FILTER_EXTRACTSTYLEBLKSCOPEDSC', 'textsarea', 'text', $p)");
     $i++;
     $p++;
     ...
     $i++;
     $p++;
     $dbm->insert('config', " VALUES ($i, 0, $c, 'purifier_Attr_EnableID', '_MD_AM_PURIFIER_ATTR_ENABLEID', '0', '_MD_AM_PURIFIER_ATTR_ENABLEIDDSC', 'yesno', 'int', $p)");
     $i++;
     $p++;
     $dbm->insert('config', " VALUES ($i, 0, $c, 'purifier_Attr_IDPrefix', '_MD_AM_PURIFIER_ATTR_IDPREFIX', 'cssuser_', '_MD_AM_PURIFIER_ATTR_IDPREFIXDSC', 'textbox', 'text', $p)");
     $i++;
     $p++;
     $dbm->insert('config', " VALUES ($i, 0, $c, 'purifier_Attr_IDPrefixLocal', '_MD_AM_PURIFIER_ATTR_IDPREFIXLOCAL', '001_', '_MD_AM_PURIFIER_ATTR_IDPREFIXLOCALDSC', 'textbox', 'text', $p)");
     $i++;
     $p++;
