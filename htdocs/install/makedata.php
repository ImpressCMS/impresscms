<?php
// $Id: makedata.php 1121 2007-10-23 01:17:53Z dugris $
//  ------------------------------------------------------------------------ //
...
function make_data(&$dbm, &$cm, $adminname, $adminpass, $adminmail, $language, $groups){
    ...
    $dbm->insert("banner", " (bid, cid, imptotal, impmade, clicks, imageurl, clickurl, date, htmlcode) VALUES (1, 1, 0, 1, 0, '".XOOPS_URL."/images/banners/xoops_banner.gif', 'http://www.xoops.org/', 1008813250, '')");
    ...
    $dbm->insert('config', " VALUES (7, 0, 1, 'theme_set', '_MD_AM_DTHEME', 'css100_morpho', '_MD_AM_DTHEMEDSC', 'theme', 'other', 12)");
	...
	$dbm->insert('config', " VALUES (39, 0, 3, 'footer', '_MD_AM_FOOTER', 'Powered by XOOPS 2.0 &copy; 2001-" . date('Y', time()) . " <a href=\"http://xoops.sourceforge.net/\" rel=\"external\">The XOOPS Project</a>', '_MD_AM_FOOTERDSC', 'textarea', 'text', 20)");
    $dbm->insert('config', " VALUES (40, 0, 4, 'censor_enable', '_MD_AM_DOCENSOR', '0', '_MD_AM_DOCENSORDSC', 'yesno', 'int', 0)");
    $dbm->insert('config', " VALUES (41, 0, 4, 'censor_words', '_MD_AM_CENSORWRD', '".addslashes(serialize(array('fuck', 'shit', 'cunt', 'wanker')))."', '_MD_AM_CENSORWRDDSC', 'textarea', 'array', 1)");
	...
	$dbm->insert('config', " VALUES (71, 0, 1, 'sslloginlink', '_MD_AM_SSLLINK', 'https://', '_MD_AM_SSLLINKDSC', 'textbox', 'text', 33)");
  	$dbm->insert('config', " VALUES (72, 0, 1, 'theme_set_allowed', '_MD_AM_THEMEOK', '".serialize(array('css100_morpho'))."', '_MD_AM_THEMEOKDSC', 'theme_multi', 'array', 13)");
    ...
    $dbm->insert('config', " VALUES (102, 0, 2, 'priv_dpolicy', '_MD_AM_PRIVDPOLICY', 1, '_MD_AM_PRIVDPOLICYDSC', 'yesno', 'int', 30)");
    $dbm->insert('config', " VALUES (103, 0, 2, 'priv_policy', '_MD_AM_PRIVPOLICY', '".addslashes(_INSTALL_PRIVPOLICY)."', '_MD_AM_PRIVPOLICYDSC', 'textarea', 'text', 32)");
