...
function make_data(&$dbm, &$cm, $adminname, $adminlogin_name, $adminpass, $adminmail, $language, $adminsalt, $gruops) {
	 ...
	 */
	$dbm->insert("modules", " VALUES (1, '"._MI_SYSTEM_NAME."'," . $modversion['version'] * 100 . ", ".$time.", 0, 1, 'system', 0, 1, 0, 0, 0, 0, 39, 'system', 0)");
	...
	$dbm->insert('config', " VALUES (" . ++$i . ", 0, $c, 'purifier_Filter_Custom', '_MD_AM_PURIFIER_FILTER_CUSTOM', '".addslashes(serialize(array('new HTMLPurifier_Filter_Vimeo()','new HTMLPurifier_Filter_WeGame()', 'new HTMLPurifier_Filter_GoogleVideo()', 'new HTMLPurifier_Filter_LocalVideo()', 'new HTMLPurifier_Filter_LiveLeak()')))."', '_MD_AM_PURIFIER_FILTER_CUSTOMDSC', 'textsarea', 'array', " . $p++ . ")");
