...
function protector_prepare()
{
    ...
    if (defined('_INSTALL_CHARSET') && !defined('XOOPS_MAINFILE_INCLUDED')) {
        die('To use installer, remove the following plugin first: /plugins/preload/protector.php') ;
    }
    ...
    // "DB Layer Trapper"
    $force_override = false !== strpos(@$_SERVER['REQUEST_URI'], 'protector/admin/index.php?page=advisory') ? true : false ;
    // $force_override = true ;
