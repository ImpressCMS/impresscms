...
function protector_prepare()
{
	...
	if( defined( '_INSTALL_CHARSET' ) && ! is_writable( XOOPS_ROOT_PATH.'/mainfile.php' ) ) die( 'To use installer, remove the follow plugin first: /plugins/preload/protector.php' ) ;
