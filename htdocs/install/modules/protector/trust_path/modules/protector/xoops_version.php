...
$modversion['config'][] = [
    ...
    'valuetype'		=> 'int' ,
    'default'		=>  255 ,
    'options'		=> [$constpref . '_LOGLEVEL0' => 0, $constpref . '_LOGLEVEL15' => 15, $constpref . '_LOGLEVEL63' => 63, $constpref . '_LOGLEVEL255' => 255]
];
$modversion['config'][] = [
    'name'			=> 'banip_time0' ,
...
$modversion['config'][] = [
    ...
    'valuetype'		=> 'int' ,
    'default'		=> 3 ,
    'options'		=> [$constpref . '_OPT_NONE' => 0, $constpref . '_OPT_EXIT' => 3, $constpref . '_OPT_BIPTIME0' => 7, $constpref . '_OPT_BIP' => 15]
];
$modversion['config'][] = [
    'name'			=> 'isocom_action' ,
