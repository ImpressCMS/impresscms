...
* @version $Id: settingmanager.php 694 2006-09-04 11:33:22Z skalpa $
* @access public
**/
class setting_manager {
    ...
    function editform(){
        ...
        $ret .= $this->editform_sub(_INSTALL_L99, _INSTALL_L98, 'dbsalt', $this->sanitizer->htmlSpecialChars($this->dbsalt));
        ...
        $ret =
            "<table border='0' cellpadding='0' cellspacing='0' valign='top' width='90%'><tr><td class='bg2'>
                <table width='100%' border='0' cellpadding='4' cellspacing='1'>
                    ...
                    <tr>
                        <td class='bg3'><b>"._INSTALL_L99."</b></td>
