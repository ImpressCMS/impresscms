...
$username = (isset($_GET['username']))
	? trim(StopXSS($_GET['username']))
	: ((isset($_POST['username'])) ? trim(StopXSS($_POST['username'])) : $username);
...
$getuser =& $member_handler->getUsers(new icms_db_criteria_Item('email', $myts->addSlashes($email)));
