...
class icms_ipf_form_Base extends icms_form_Theme {
	...
	public function render() {
		...
		$ret = "
			<form name='taco_".$this->getName()."_dorga' id='".$this->getName()."' action='".$this->getAction()."' method='".$this->getMethod()."' onsubmit='return xoopsFormValidate_".$this->getName()."(this);'".$this->getExtra().">
