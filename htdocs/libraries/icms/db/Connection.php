...
class icms_db_Connection extends PDO implements icms_db_IConnection
{
    ...
    public function query()
    {
        ...
        if ($result) {
            icms_Event::trigger('icms_db_IConnection', 'execute', $this, ['sql' => $args[0], 'errorno' => null, 'error' => null]);
        } else {
            $errorinfo = $this->errorInfo();
            icms_Event::trigger('icms_db_IConnection', 'execute', $this, ['sql' => $args[0], 'errorno' => $errorinfo[1], 'error' => $errorinfo[2]]);
        }
