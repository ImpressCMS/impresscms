 ...
 * @license		http://www.gnu.org/licenses/old-licenses/gpl-2.0.html GNU General Public License (GPL)
 */
class icms_db_icms_mysql_Database extends icms_db_icms_Database {
	/**
	 * Database connection
	 * @var resource
	 */
	...
	function queryFromFile($file) {
		if (false !== ($fp = fopen($file, 'r'))) {
			...
			icms_db_icms_mysql_Utility :: splitMySqlFile($pieces, $sql_queries);
			foreach ($pieces as $query) {
				// [0] contains the prefixed query
				// [4] contains unprefixed table name
				$prefixed_query = icms_db_icms_mysql_Utility :: prefixQuery(trim($query), $this->prefix());
