 ...
 * @version $Id: databaseupdater.php 19866 2010-07-17 20:00:30Z phoenyx $
...
/**
 * Include the language constants for the icms_db_icms_updater_Handler
 */
 ...
 * @link http://www.smartfactory.ca The SmartFactory
 */
class icms_db_icms_updater_Handler {
	 ...
	 *
	 * @param object $table {@link icms_db_icms_updater_Table} that will be updated
	 * @param bool	$force force the query even in a GET process
	 *
	 * @see icms_db_icms_updater_Table
	 *
	 * @return bool true if success, false if an error occured
	 */
	...
	function upgradeObjectItem($dirname, $item) {
		...
		$table = new icms_db_icms_updater_Table($dirname . '_' . $item);
