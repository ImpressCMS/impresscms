...
class icms_Autoloader
{
     ...
     * @var array
     */
    protected static $globalRepositories = [];
    /**
     ...
     */
    protected static $localRepositories = [];
    /**
     * Imported namespaces
     * @var array
     */
    ...
    public static function setup()
    {
        if (!self::$initialized) {
            ...
            spl_autoload_register(['icms_Autoloader', 'autoload']);
            spl_autoload_register(['icms_Autoloader', 'registerLegacy']);
     ...
     */
    public static function registerLegacy($class)
    {
