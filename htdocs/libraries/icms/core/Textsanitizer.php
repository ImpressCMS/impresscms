...
class icms_core_Textsanitizer
{
    ...
    public function displayTarea($text, $html = 0, $smiley = 1, $xcode = 1, $image = 1, $br = 1)
    {
        ...
        icms::$preload->triggerEvent('beforeDisplayTarea', [&$text, $html, $smiley, $xcode, $image, $br]);
        ...
        icms::$preload->triggerEvent('afterDisplayTarea', [&$text, $html, $smiley, $xcode, $image, $br]);
        return $text;
    }
    ...
    public function previewTarea($text, $html = 0, $smiley = 1, $xcode = 1, $image = 1, $br = 1)
    {
        ...
        icms::$preload->triggerEvent('beforePreviewTarea', [&$text, $html, $smiley, $xcode, $image, $br]);
        ...
        icms::$preload->triggerEvent('afterPreviewTarea', [&$text, $html, $smiley, $xcode, $image, $br]);
