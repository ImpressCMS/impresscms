...
class icms_core_Filesystem
{
     ...
     */
    public static function mkdir($target, $mode = 0777, $base = ICMS_ROOT_PATH, $metachars = [])
    {
        if (is_dir($target)) {
            return true;
        }
     ...
     */
    public static function getDirList($dirname, array $ignore = ['cvs', '_darcs', '.svn'], $hideDot = true)
    {
        $dirList = [];
