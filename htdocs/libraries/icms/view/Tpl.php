...
class icms_view_Tpl extends Smarty {
	...
	function xoops_setTemplateDir($dirname) {
		...
		icms_deprecated('$this->template_dir = $dirname', sprintf(_CORE_REMOVE_IN_VERSION, '1.4'));
	}
	/**
	...
	function xoops_getTemplateDir() {
		icms_deprecated('$this->template_dir', sprintf(_CORE_REMOVE_IN_VERSION, '1.4'));
	...
	function xoops_setDebugging($flag=false) {
		...
		icms_deprecated('$this->debugging = $flag', sprintf(_CORE_REMOVE_IN_VERSION, '1.4'));
	}
	/**
	...
	function xoops_setCompileDir($dirname) {
		...
		icms_deprecated('$this->compile_dir = $dirname', sprintf(_CORE_REMOVE_IN_VERSION, '1.4'));
	}
	/**
	...
	function xoops_setCacheDir($dirname) {
		...
		icms_deprecated('$this->cache_dir = $dirname', sprintf(_CORE_REMOVE_IN_VERSION, '1.4'));
	}
	/**
	...
	function xoops_canUpdateFromFile() {
		icms_deprecated('$this->compile_check', sprintf(_CORE_REMOVE_IN_VERSION, '1.4'));
	...
	function xoops_setCacheTime( $num = 0) {
		if (( $num = (int)$num ) <= 0) {
			...
			icms_deprecated('$this->cache_lifetime = $num', sprintf(_CORE_REMOVE_IN_VERSION, '1.4'));
