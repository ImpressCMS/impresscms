...
class icms_view_theme_Object
{
     ...
     * @public array
     */
    public $plugins = ['icms_view_PageBuilder'];
     ...
     */
    public $types = ['http', 'meta', 'link', 'stylesheet', 'script', 'property', 'itemprop'];
    ...
    public function xoInit($options = [])
    {
        ...
        $this->template->assign(
            [
                ...
                'icms_banner' => isset($icmsConfig['banners']) ? xoops_getbanner() : '&nbsp;',
  ...
  ga('send', 'pageview');
    ...
    public function render($canvasTpl = null, $pageTpl = null, $contentTpl = null, $vars = [])
    {
        ...
        if ($xheader != '') {
            icms_core_Debug::setDeprecated('icms_module_header', sprintf(_CORE_REMOVE_IN_VERSION, '2.0'));
        }
        ...
        if ($xpagetitle != '') {
            icms_core_Debug::setDeprecated('icms_pagetitle', sprintf(_CORE_REMOVE_IN_VERSION, '2.0'));
        }
