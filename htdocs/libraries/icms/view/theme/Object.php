			...
			switch($type) {
				...
				case 'http':
					foreach ($this->metas[$zone][$type] as $name => $content) {
						$str .= '<meta http-equiv="' . htmlspecialchars($name, ENT_QUOTES, _CHARSET) . '" content="' . htmlspecialchars($content, ENT_QUOTES, _CHARSET) . "\" />\n";
					}
					break;

				default:
					foreach ($this->metas[$zone][$type] as $name => $content) {
						$str .= '<meta name="' . htmlspecialchars($name, ENT_QUOTES, _CHARSET) . '" content="' . htmlspecialchars($content['value'], ENT_QUOTES, _CHARSET) . "\" />\n";
					}
					break;
			}
		}
