...
class icms_form_elements_Dhtmltextarea extends icms_form_elements_Textarea {
	...
	public function render() {
		...
		$ret = "<a name='moresmiley'></a>"
			. "<img onmouseover='style.cursor=\"pointer\"' src='" . ICMS_URL . "/images/url.gif' alt='url' onclick='xoopsCodeUrl(\"" . $ele_name . "\", \"" . htmlspecialchars(_ENTERURL, ENT_QUOTES, _CHARSET) . "\", \"" . htmlspecialchars(_ENTERWEBTITLE, ENT_QUOTES, _CHARSET) . "\");' />&nbsp;"
			...
			. "<img onclick='javascript:xoopsCodeImg(\"" . $ele_name . "\", \"" . htmlspecialchars(_ENTERIMGURL, ENT_QUOTES, _CHARSET) . "\", \"" . htmlspecialchars(_ENTERIMGPOS, ENT_QUOTES, _CHARSET) . "\", \"" . htmlspecialchars(_IMGPOSRORL, ENT_QUOTE, _CHARSET) . "\", \"" . htmlspecialchars(_ERRORIMGPOS, ENT_QUOTES, _CHARSET) . "\");' onmouseover='style.cursor=\"pointer\"' src='" . ICMS_URL . "/images/imgsrc.gif' alt='imgsrc' />&nbsp;"
		...
		$ret .= "<img onclick='javascript:xoopsmake" . _GLOBAL_LEFT . "(\"" . $ele_name 
			...
			. htmlspecialchars(((defined('_ADM_USE_RTL') && _ADM_USE_RTL)
				? _ALRIGHTCON
				: _ALLEFTCON), ENT_QUOTES, _CHARSET) 
			...
			. htmlspecialchars(((defined('_ADM_USE_RTL') && _ADM_USE_RTL)
				? _ALLEFTCON
				: _ALRIGHTCON), ENT_QUOTES, _CHARSET) 
