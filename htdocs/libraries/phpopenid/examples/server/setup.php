			...
			<div class="store_fields">
				...
				<div>
					<input type="radio" name="store_type" value="Filesystem"
						   id="i_filesystem"<?php if ($_SESSION['store_type'] == 'Filesystem') {
						print " CHECKED";
					} ?>>
				...
				<?php if ($sqlite_found) { ?>
					<div>
						<input type="radio" name="store_type" value="SQLite"
							   id="i_sqlite"<?php if ($_SESSION['store_type'] == 'SQLite') {
							print " CHECKED";
						} ?>>
					...
					<div>
						...
						<?php if ($mysql_found) { ?>
							<input type="radio" name="store_type" value="MySQL"
								   id="i_mysql"<?php if ($_SESSION['store_type'] == 'MySQL') {
								print " CHECKED";
							} ?>>
						...
						<?php if ($pgsql_found) { ?>
							<input type="radio" name="store_type" value="PostgreSQL"
								   id="i_pgsql"<?php if ($_SESSION['store_type'] == 'PostgreSQL') {
								print " CHECKED";
							} ?>>
						...
						<div>
							...
							<input type="text" value="<?php print @$_SESSION['store_data']['host']; ?>" name="host"
								   id="i_m_host">
						</div>
						<div>
							<label for="i_m_database" class="field">Database:</label>
							<input value="<?php print @$_SESSION['store_data']['database']; ?>" type="text"
								   name="database" id="i_m_database">
						</div>
						<div>
							<label for="i_m_username" class="field">Username:</label>
							<input type="text" name="username" id="i_m_username"
								   value="<?php print @$_SESSION['store_data']['username']; ?>">
						</div>
						<div>
...
function generate_config($download = false)
{
	...
	if ($download) {
		...
		<p>
			Put the following text into <strong><?php print dirname(__FILE__);
				print DIRECTORY_SEPARATOR; ?>config.php</strong>.
		</p>
