...
function filter_preview(buttonObj) {
	...
	var url =
		filter_script_server_file +
		"?image_path=" +
		xoopsGetElementById("fimage_path").value +
		"&image_url=" +
		xoopsGetElementById("fimage_url").value +
		"&filter=" +
		xoopsGetElementById("filter").value +
		"&arg1=" +
		xoopsGetElementById("arg1").value +
		"&arg2=" +
		xoopsGetElementById("arg2").value +
		"&arg3=" +
		xoopsGetElementById("arg3").value;
	...
	filterScriptAjaxObjects[ajaxIndex].onCompletion = function() {
		filterCompleted(ajaxIndex, buttonObj);
