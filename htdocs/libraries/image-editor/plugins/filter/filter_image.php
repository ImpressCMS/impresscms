...
if ($submitted_url['scheme'] != $base_url['scheme']) {
    $image_url = null;
}
if ($submitted_url['host'] != $base_url['host']) {
    $image_url = null;
}
if ($submitted_url['path'] != parse_url(ICMS_IMANAGER_FOLDER_URL . '/temp/' . basename($image_path), PHP_URL_PATH)) {
    $image_url = null;
}
