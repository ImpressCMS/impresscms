...
function hidePanels(numericId) {
	for (i = 0; i <= permPanels.length - 1; i++) {
		...
		outerContentDiv = document.getElementById("paneContent" + i)
			? document.getElementById("paneContent" + i)
			: null;
	...
	for (var no = 0; no < divs.length; no++) {
		if (divs[no].className == "dhtmlgoodies_panel") {
			...
			if (cookieArray[dhtmlgoodies_paneIndex]) {
				...
				if (cookieValue)
					panelDisplayed[dhtmlgoodies_paneIndex] =
						cookieValue == 1 ? true : false;
			}
...
function cancel_edit() {
	...
	var url =
		script_server_file +
		"?op=cancel&image_path=" +
		document.getElementById("save_img_path").value;
...
function save_edit() {
	...
	var url =
		script_server_file +
		"?op=save&image_id=" +
		document.getElementById("save_img_id").value +
		"&image_temp=" +
		document.getElementById("save_img_tempname").value +
		"&image_name=" +
		document.getElementById("save_img_name").value +
		"&image_weight=" +
		document.getElementById("save_img_weight").value +
		"&image_display=" +
		document.getElementById("save_img_display").value +
		"&overwrite=" +
		document.getElementById("soverwrite").value;
