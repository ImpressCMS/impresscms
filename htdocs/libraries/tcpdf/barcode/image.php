...
require_once(dirname(__FILE__)."/i25object.php");
require_once(dirname(__FILE__)."/c39object.php");
require_once(dirname(__FILE__)."/c128aobject.php");
require_once(dirname(__FILE__)."/c128bobject.php");
require_once(dirname(__FILE__)."/c128cobject.php");
