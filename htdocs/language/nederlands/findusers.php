...
define("_MA_USER_LOCATION","Lokatie");
define("_MA_USER_OCCUPATION","Beroep");
define("_MA_USER_INTEREST","Interesses");
define("_MA_USER_URLC","Website");
define("_MA_USER_SORT","Gesorteerd op");
define("_MA_USER_ORDER","Volgorde");
define("_MA_USER_LASTLOGIN","Laatste keer ingelogd");
define("_MA_USER_POSTS","Aantal berichten");
define("_MA_USER_ASC","Oplopend");
define("_MA_USER_DESC","Aflopend");
define("_MA_USER_LIMIT","Aantal gebruikers per pagina");
define("_MA_USER_RESULTS", "Zoekresultaten");
define("_MA_USER_SHOWMAILOK", "Toon gebruikers die");
...
define("_MA_USER_BOTH", "Alle gebruikers");

define("_MA_USER_RANGE_LAST_LOGIN","Ingelogd in het verleden <span style='color:#ff0000;'>X</span>dagen");
define("_MA_USER_RANGE_USER_REGDATE","Geregistreerd in het verleden <span style='color:#ff0000;'>X</span>dagen");
define("_MA_USER_RANGE_POSTS","Berichten");

define("_MA_USER_HASAVATAR", "Heeft pasfoto");
...
define("_MA_USER_SEARCHAGAIN", "Opnieuw zoeken");
