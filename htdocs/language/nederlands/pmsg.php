...
define('_PM_INBOX', 'Postvak in');
define('_PM_FROM', 'Van');
define('_PM_YOUDONTHAVE', 'Er zijn geen privéberichten');
define('_PM_FROMC', 'Van: ');
define('_PM_SENTC', 'Verzonden: ');
// The date of message sent
define('_PM_PROFILE', 'Profiel');
// %s is a username
...
define('_PM_TO', 'Aan: ');
define('_PM_SUBJECTC', 'Onderwerp: ');
define('_PM_MESSAGEC', 'Bericht: ');
define('_PM_CLEAR', 'Wissen');
define('_PM_CANCELSEND', 'Annuleren');
define('_PM_SUBMIT', 'Verzenden');
