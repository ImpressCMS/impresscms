...
#############  since 1.2 #############
define('_DATABASEUPDATER_MSG_DB_VERSION_ERR', 'Impossible de mettre � jour la module dbversion');
define('_DATABASEUPDATER_LATESTVER', "Derni�re version de la db : <span class='currentVer'>%s</span>");
define('_DATABASEUPDATER_MSG_CONFIG_ERR', "Impossible d'ins�rer configuration %s");
