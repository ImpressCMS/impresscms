...
#############  since 1.2 #############
define("_DATABASEUPDATER_MSG_DB_VERSION_ERR", "Impossible de mettre à jour la module dbversion");
define("_DATABASEUPDATER_LATESTVER", "Dernière version de la db : <span class='currentVer'>%s</span>");
define("_DATABASEUPDATER_MSG_CONFIG_ERR", "Impossible d'insérer configuration %s");
define("_DATABASEUPDATER_MSG_CONFIG_SCC", "Configuration %s ajouté");
