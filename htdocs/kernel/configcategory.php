...
class XoopsConfigCategory extends icms_config_category_Object
{
	...
	{
		parent::__construct();
		$this->_deprecated = icms_deprecated('icms_config_category_Object', sprintf(_CORE_REMOVE_IN_VERISON, '1.4'));
...
class XoopsConfigCategoryHandler extends icms_config_category_Handler
{
	...
	public function __construct(&$db) {
		...
		$this->_deprecated = icms_deprecated('icms_config_category_Handler', sprintf(_CORE_REMOVE_IN_VERISON, '1.4'));
	}
