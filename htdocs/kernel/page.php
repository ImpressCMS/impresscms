...
class IcmsPage extends icms_page_Object {
	...
	public function __construct( & $handler ){
		...
		$this->_deprecated = icms_deprecated('icms_page_Object', sprintf(_CORE_REMOVE_IN_VERSION, '1.4'));
...
class IcmsPageHandler extends icms_page_Handler {
	...
	public function __construct( & $db ){
		...
		$this->_deprecated = icms_deprecated('icms_page_Handler', sprintf(_CORE_REMOVE_IN_VERSION, '1.4'));
	}
