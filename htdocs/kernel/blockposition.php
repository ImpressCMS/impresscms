...
class IcmsBlockposition extends icms_block_position_Object {
	...
	public function __construct() {
		parent::__construct();
		$this->_deprecated = icms_core_Debug::setDeprecated('icms_block_position_Object', sprintf(_CORE_REMOVE_IN_VERSION, '1.4'));
	}
}
/**
...
class IcmsBlockpositionHandler extends icms_block_position_Handler {
	...
	public function __construct() {
		parent::__construct();
		$this->_deprecated = icms_core_Debug::setDeprecated('icms_block_position_Handler', sprintf(_CORE_REMOVE_IN_VERSION, '1.4'));
	}
}