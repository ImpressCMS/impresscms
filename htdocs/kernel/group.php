...
class XoopsGroup extends icms_member_group_Object {
	...
	public function __construct() {
		parent::getInstance();
		$this->_deprecated = icms_deprecated('icms_member_group_Object', sprintf(_CORE_REMOVE_IN_VERSION, '1.4'));
	}
}
/**
...
class XoopsGroupHandler extends icms_member_group_Handler {
	...
	public function __construct() {
		parent::getInstance();
		$this->_deprecated = icms_deprecated('icms_member_group_Handler', sprintf(_CORE_REMOVE_IN_VERSION, '1.4'));
	}
}
/**
...
class XoopsMembership extends icms_member_group_membership_Object {
	...
	public function __construct() {
		parent::getInstance();
		$this->_deprecated = icms_deprecated('icms_member_group_membership_Object', sprintf(_CORE_REMOVE_IN_VERSION, '1.4'));
	}
}
/**
...
class XoopsMembershipHandler extends icms_member_group_membership_Handler {
	...
	public function __construct() {
		parent::getInstance();
		$this->_deprecated = icms_deprecated('icms_member_group_membership_Handler', sprintf(_CORE_REMOVE_IN_VERSION, '1.4'));
	}
}