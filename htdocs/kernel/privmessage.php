...
class XoopsPrivmessage extends icms_privmessage_Object
{
	...
	{
		parent::__construct();
		$this->_deprecated = icms_core_Debug::setDeprecated('icms_privmessage_Object', sprintf(_CORE_REMOVE_IN_VERSION, '1.4'));
	}
}
...
class XoopsPrivmessageHandler extends icms_privmessage_Handler
{
	...
	public function XoopsPrivmessageHandler() {
		...
		$this->_deprecated = icms_core_Debug::setDeprecated('icms_privmessage_Handler', sprintf(_CORE_REMOVE_IN_VERSION, '1.4'));
		return $pmHandler;
	}
}
