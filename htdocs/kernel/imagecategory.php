...
class XoopsImagecategory extends icms_image_category_Object {
	...
	public function __construct() {
		parent::getInstance();
		$this->_deprecated = icms_deprecated('icms_image_category_Object', sprintf(_CORE_REMOVE_IN_VERSION, '1.4'));
	}
}
...
class XoopsImagecategoryHandler extends icms_image_category_Handler {
	...
	public function __construct() {
		parent::getInstance();
		$this->_deprecated = icms_deprecated('icms_image_category_Handler', sprintf(_CORE_REMOVE_IN_VERSION, '1.4'));
	}
}
?>