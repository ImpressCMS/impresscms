...
class XoopsImage extends icms_image_Object {
	...
	public function __construct() {
		parent::getInstance();
		$this->_deprecated = icms_deprecated('icms_image_Object', sprintf(_CORE_REMOVE_IN_VERSION, '1.4'));
	}
}
...
class XoopsImageHandler extends icms_image_Handler {
	...
	public function __construct() {
		parent::getInstance();
		$this->_deprecated = icms_deprecated('icms_image_Handler', sprintf(_CORE_REMOVE_IN_VERSION, '1.4'));
	}
}
