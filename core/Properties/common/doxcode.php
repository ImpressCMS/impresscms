...
$this->initVar($varname, \ImpressCMS\Core\Properties\AbstractProperties::DTYPE_INTEGER, $value, false, null, "", false, _CO_ICMS_DOXCODE_FORM_CAPTION, '', false, true, $displayOnForm);
