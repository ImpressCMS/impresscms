...
class ThemeComponent
{
  ...
  ga('send', 'pageview');
	...
	{
		echo $this->fetch($canvasTpl, $pageTpl, $contentTpl, $vars);
	}

	/**
	 * Fetches rendered page
	 *
	 * Similar to render but doesn't display result
	 *
	 * @param string $canvasTpl The canvas template, if different from the theme default
	 * @param string $pageTpl The page template, if different from the theme default (unsupported, 2.3+ only)
	 * @param string $contentTpl The content template
	 ...
	 * @throws SmartyException
	 */
	public function fetch($canvasTpl = null, $pageTpl = null, $contentTpl = null, $vars = []): string
	{
