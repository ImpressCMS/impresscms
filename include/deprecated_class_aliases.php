...
return [
	...
	'icms_core_Filesystem' => \ImpressCMS\Core\File\Filesystem::class,
	...
	'icms_core_Object' => \ImpressCMS\Core\Models\AbstractModel::class,
	'icms_core_ObjectHandler' => \ImpressCMS\Core\Models\AbstractHandler::class,
	'icms_core_OnlineHandler' => \ImpressCMS\Core\Models\OnlineHandler::class,
	'icms_core_Password' => \ImpressCMS\Core\Security\Password::class,
	'icms_core_Security' => \ImpressCMS\Core\Security\RequestSecurity::class,
	'icms_core_StopSpammer' => \ImpressCMS\Core\Security\StopSpammer::class,
	...
	'icms_data_comment_Renderer' => \ImpressCMS\Core\View\Renderer\CommentRenderer::class,
	...
	'icms_feeds_Rss' => \ImpressCMS\Core\Data\Feeds\Rss::class,
	'icms_feeds_Simplerss' => \ImpressCMS\Core\Data\Feeds\Simplerss::class,
	...
	'icms_ipf_export_Handler' => \ImpressCMS\Core\Data\Export\Exporter::class,
	'icms_ipf_export_Renderer' => \ImpressCMS\Core\Data\Export\ExportRenderer::class,
	'icms_ipf_form_elements_Autocomplete' => \ImpressCMS\Core\View\ModelLinkedForm\Elements\AutocompleteElement::class,
	'icms_ipf_form_elements_Blockoptions' => \ImpressCMS\Core\View\ModelLinkedForm\Elements\BlockOptionsElement::class,
	'icms_ipf_form_elements_Checkbox' => \ImpressCMS\Core\View\ModelLinkedForm\Elements\CheckboxElement::class,
	'icms_ipf_form_elements_Date' => \ImpressCMS\Core\View\ModelLinkedForm\Elements\DateElement::class,
	'icms_ipf_form_elements_Datetime' => \ImpressCMS\Core\View\ModelLinkedForm\Elements\DateTimeElement::class,
	'icms_ipf_form_elements_File' => \ImpressCMS\Core\View\ModelLinkedForm\Elements\FileElement::class,
	'icms_ipf_form_elements_Fileupload' => \ImpressCMS\Core\View\ModelLinkedForm\Elements\FileUploadElement::class,
	'icms_ipf_form_elements_Image' => \ImpressCMS\Core\View\ModelLinkedForm\Elements\ImageElement::class,
	'icms_ipf_form_elements_Imageupload' => \ImpressCMS\Core\View\ModelLinkedForm\Elements\ImageUploadElement::class,
	'icms_ipf_form_elements_Language' => \ImpressCMS\Core\View\ModelLinkedForm\Elements\LanguageElement::class,
	'icms_ipf_form_elements_Page' => \ImpressCMS\Core\View\ModelLinkedForm\Elements\PageElement::class,
	'icms_ipf_form_elements_Parentcategory' => \ImpressCMS\Core\View\ModelLinkedForm\Elements\ParentCategoryElement::class,
	'icms_ipf_form_elements_Passwordtray' => \ImpressCMS\Core\View\ModelLinkedForm\Elements\PasswordTrayElement::class,
	'icms_ipf_form_elements_Radio' => \ImpressCMS\Core\View\ModelLinkedForm\Elements\RadioElement::class,
	'icms_ipf_form_elements_Richfile' => \ImpressCMS\Core\View\ModelLinkedForm\Elements\RichfileElement::class,
	'icms_ipf_form_elements_Section' => \ImpressCMS\Core\View\ModelLinkedForm\Elements\FormSectionElement::class,
	'icms_ipf_form_elements_Select' => \ImpressCMS\Core\View\ModelLinkedForm\Elements\SelectElement::class,
	'icms_ipf_form_elements_Selectmulti' => \ImpressCMS\Core\View\ModelLinkedForm\Elements\SelectMultiElement::class,
	'icms_ipf_form_elements_Signature'=> \ImpressCMS\Core\View\ModelLinkedForm\Elements\SignatureElement::class,
	'icms_ipf_form_elements_Source' => \ImpressCMS\Core\View\ModelLinkedForm\Elements\SourceElement::class,
	'icms_ipf_form_elements_Text' => \ImpressCMS\Core\View\ModelLinkedForm\Elements\TextElement::class,
	'icms_ipf_form_elements_Time' => \ImpressCMS\Core\View\ModelLinkedForm\Elements\TimeElement::class,
	'icms_ipf_form_elements_Upload' => \ImpressCMS\Core\View\ModelLinkedForm\Elements\UploadElement::class,
	'icms_ipf_form_elements_Urllink' => \ImpressCMS\Core\View\ModelLinkedForm\Elements\URLLinkElement::class,
	'icms_ipf_form_elements_User' => \ImpressCMS\Core\View\ModelLinkedForm\Elements\UserElement::class,
	'icms_ipf_form_elements_Yesno' => \ImpressCMS\Core\View\ModelLinkedForm\Elements\YesNoElement::class,
	'icms_ipf_form_Base' => \ImpressCMS\Core\View\ModelLinkedForm\Form::class,
	'icms_ipf_form_Secure' => \ImpressCMS\Core\View\ModelLinkedForm\SecureForm::class,
	'icms_ipf_member_Handler' => \ImpressCMS\Core\Facades\Member::class,
	'icms_ipf_permission_Handler' => \ImpressCMS\Core\Security\PermissionsManager::class,
	'icms_ipf_registry_Handler' => \ImpressCMS\Core\ObjectRegistry::class,
	'icms_ipf_seo_Object' => \ImpressCMS\Core\Models\AbstractSEOExtendedModel::class,
	'icms_ipf_view_Column' => \ImpressCMS\Core\View\Table\Column::class,
	'icms_ipf_view_Row' => \ImpressCMS\Core\View\Table\Row::class,
	'icms_ipf_view_Single' => \ImpressCMS\Core\View\Renderer\ModelViewRenderer::class,
	'icms_ipf_view_Table' => \ImpressCMS\Core\View\Table\Table::class,
	'icms_ipf_view_Tree' => \ImpressCMS\Core\View\Table\TableTree::class,
	'icms_ipf_About' => \ImpressCMS\Core\View\Renderer\ModuleAboutRenderer::class,
	'icms_ipf_Controller' => \ImpressCMS\Core\ModelController::class,
	'icms_ipf_Handler' => \ImpressCMS\Core\Models\AbstractExtendedHandler::class,
	'icms_ipf_Highlighter' => \ImpressCMS\Core\View\Highlighter::class,
	'icms_ipf_Metagen' => \ImpressCMS\Core\Metagen::class,
	'icms_ipf_Object' => \ImpressCMS\Core\Models\AbstractExtendedModel::class,
	'icms_ipf_Tree' => \ImpressCMS\Core\ObjectTree::class,
	...
	'icms_messaging_Handler' => \ImpressCMS\Core\Messaging\MessageSender::class,
	'icms_module_Handler' => \ImpressCMS\Core\Models\ModuleHandler::class,
	'icms_module_Object' => \ImpressCMS\Core\Models\Module::class,
	'icms_plugins_EditorHandler' => \ImpressCMS\Core\Extensions\Editors\EditorsRegistry::class,
	'icms\\plugins\\EditorInterface' => \ImpressCMS\Core\Extensions\Editors\EditorInterface::class,
	'icms_plugins_Handler' => \ImpressCMS\Core\Extensions\Plugins\PluginRegistry::class,
	'icms_plugins_Object' => \ImpressCMS\Core\Extensions\Plugins\Plugin::class,
	'icms_preload_Handler' => \ImpressCMS\Core\Extensions\Preload\EventsPreloader::class,
	'icms_preload_Item' => \ImpressCMS\Core\Extensions\Preload\AbstractPreloadItem::class,
	'icms_preload_LibrariesHandler' => \ImpressCMS\Core\Extensions\Preload\LibrariesPreloader::class,
	'icms_properties_Handler' => \ImpressCMS\Core\Properties\AbstractProperties::class,
	'icms_sys_autotasks_ISystem' => \ImpressCMS\Core\Extensions\Autotasks\AutotaskSystemInterface::class,
	'icms_sys_autotasks_System' => \ImpressCMS\Core\Extensions\Autotasks\AbstractAutotaskSystem::class,
	...
	'icms_view_Breadcrumb' => \ImpressCMS\Core\View\Renderer\BreadcrumbRenderer::class,
	'icms_view_PageBuilder' => \ImpressCMS\Core\View\PageBuilder::class,
	'icms_view_PageNav' => \ImpressCMS\Core\View\PageNav::class,
	'icms_view_Printerfriendly' => \ImpressCMS\Core\View\Renderer\PrinterFriendlyViewRenderer::class,
