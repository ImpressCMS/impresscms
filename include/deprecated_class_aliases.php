...
return [
	...
	'icms_data_avatar_Handler' => \ImpressCMS\Core\Data\AvatarHandler::class,
	'icms_data_avatar_Object' => \ImpressCMS\Core\Data\Avatar::class,
	'icms_data_comment_Handler' => \ImpressCMS\Core\Data\CommentHandler::class,
	'icms_data_comment_Object' => \ImpressCMS\Core\Data\Comment::class,
	'icms_data_comment_Renderer' => \ImpressCMS\Core\Data\CommentRenderer::class,
	'icms_data_file_Handler' => \ImpressCMS\Core\Data\FileHandler::class,
	'icms_data_file_Object' => \ImpressCMS\Core\Data\File::class,
	'icms_data_notification_Handler' => ImpressCMS\Core\Data\NotificationHandler::class,
	'icms_data_notification_Object' => \ImpressCMS\Core\Data\Notification::class,
	'icms_data_page_Handler' => \ImpressCMS\Core\Data\PageHandler::class,
	'icms_data_page_Object' => \ImpressCMS\Core\Data\Page::class,
	'icms_data_privmessage_Handler' => \ImpressCMS\Core\Data\PrivateMessageHandler::class,
	'icms_data_privmessage_Object' => \ImpressCMS\Core\Data\PrivateMessage::class,
	'icms_data_urllink_Handler' => \ImpressCMS\Core\Data\UrlLinkHandler::class,
	'icms_data_urllink_Object' => \ImpressCMS\Core\Data\UrlLink::class,
	...
	'icms_image_body_Object' => \ImpressCMS\Core\Image\ImageBody::class,
	'icms_image_category_Handler' => \ImpressCMS\Core\Image\ImageCategoryHandler::class,
	'icms_image_category_Object' => \ImpressCMS\Core\Image\ImageCategory::class,
	'icms_image_set_Handler' => \ImpressCMS\Core\Image\ImageSetHandler::class,
	'icms_image_set_Object' => \ImpressCMS\Core\Image\ImageSet::class,
	'icms_image_Handler' => \ImpressCMS\Core\Image\ImageHandler::class,
	'icms_image_Object' => \ImpressCMS\Core\Image\Image::class,
	'icms_ipf_category_Handler' => \ImpressCMS\Core\IPF\Category\CategoryHandler::class,
	'icms_ipf_category_Object' => \ImpressCMS\Core\IPF\Category\Category::class,
	...
	'icms_member_group_membership_Object' => \ImpressCMS\Core\Member\Group\GroupMembership::class,
	'icms_member_group_Handler' => \ImpressCMS\Core\Member\Group\GroupHandler::class,
	'icms_member_group_Object'=>\ImpressCMS\Core\Member\Group\Group::class,
	'icms_member_groupperm_Handler'=>\ImpressCMS\Core\Member\Group\GroupPermHandler::class,
	'icms_member_groupperm_Object'=>\ImpressCMS\Core\Member\Group\GroupPerm::class,
	'icms_member_rank_Handler' => \ImpressCMS\Core\Member\UserRankHandler::class,
	'icms_member_rank_Object' => \ImpressCMS\Core\Member\UserRank::class,
	'icms_member_user_Handler' => \ImpressCMS\Core\Member\UserHandler::class,
	'icms_member_user_Object' => \ImpressCMS\Core\Member\User::class,
	...
	'icms_module_Object' => \ImpressCMS\Core\Module\Module::class,
	...
	'icms_view_block_position_Handler' => \ImpressCMS\Core\View\Block\BlockPositionHandler::class,
	'icms_view_block_position_Object' => \ImpressCMS\Core\View\Block\BlockPosition::class,
	'icms_view_block_Handler' => \ImpressCMS\Core\View\Block\BlockHandler::class,
	'icms_view_block_Object' => \ImpressCMS\Core\View\Block\Block::class,
	'icms_view_template_file_Handler' => \ImpressCMS\Core\View\Template\TemplateFileHandler::class,
	'icms_view_template_file_Object' => \ImpressCMS\Core\View\Template\TemplateFile::class,
	'icms_view_template_set_Handler' => \ImpressCMS\Core\View\Template\TemplateSetHandler::class,
	'icms_view_template_set_Object' => \ImpressCMS\Core\View\Template\TemplateSet::class,
