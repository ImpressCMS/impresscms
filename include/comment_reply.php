...
//themecenterposts($comment->com_title, $r_text);
echo '<table cellpadding="4" cellspacing="1" width="98%" class="outer"><tr><td class="head">' . $comment->com_title . '</td></tr><tr><td><br />' . $r_text . '<br /></td></tr></table>';
