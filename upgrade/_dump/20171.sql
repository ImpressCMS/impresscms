...
INSERT INTO `xoops_banner` VALUES (1, 1, 0, 1, 0, 'http://localhost/workspace/20171/images/banners/xoops_banner.gif', 'http://www.xoops.org/', 1008813250, 0, '');
INSERT INTO `xoops_banner` VALUES (2, 1, 0, 1, 0, 'http://localhost/workspace/20171/images/banners/xoops_banner_2.gif', 'http://www.xoops.org/', 1008813250, 0, '');
INSERT INTO `xoops_banner` VALUES (3, 1, 0, 1, 0, 'http://localhost/workspace/20171/images/banners/banner.swf', 'http://www.xoops.org/', 1008813250, 0, '');
...
CREATE TABLE `xoops_config` (
  ...
  `conf_title` varchar(30) collate latin1_general_ci NOT NULL default '',
  `conf_value` text collate latin1_general_ci NOT NULL,
  `conf_desc` varchar(30) collate latin1_general_ci NOT NULL default '',
...
CREATE TABLE `xoops_configcategory` (
  ...
  `confcat_name` varchar(25) collate latin1_general_ci NOT NULL default '',
...
INSERT INTO `xoops_modules` VALUES (1, 'System', 102, 1198158961, 0, 1, 'system', 0, 1, 0, 0, 0, 0);
...
INSERT INTO `xoops_newblocks` VALUES (1, 1, 1, '', 'User Menu', 'User Menu', '', 0, 0, 1, 'S', 'H', 1, 'system', 'system_blocks.php', 'b_system_user_show', '', 'system_block_user.html', 0, 1198158961);
INSERT INTO `xoops_newblocks` VALUES (2, 1, 2, '', 'Login', 'Login', '', 0, 0, 1, 'S', 'H', 1, 'system', 'system_blocks.php', 'b_system_login_show', '', 'system_block_login.html', 0, 1198158961);
INSERT INTO `xoops_newblocks` VALUES (3, 1, 3, '', 'Search', 'Search', '', 0, 0, 0, 'S', 'H', 1, 'system', 'system_blocks.php', 'b_system_search_show', '', 'system_block_search.html', 0, 1198158961);
INSERT INTO `xoops_newblocks` VALUES (4, 1, 4, '', 'Waiting Contents', 'Waiting Contents', '', 0, 0, 0, 'S', 'H', 1, 'system', 'system_blocks.php', 'b_system_waiting_show', '', 'system_block_waiting.html', 0, 1198158961);
INSERT INTO `xoops_newblocks` VALUES (5, 1, 5, '', 'Main Menu', 'Main Menu', '', 0, 0, 1, 'S', 'H', 1, 'system', 'system_blocks.php', 'b_system_main_show', '', 'system_block_mainmenu.html', 0, 1198158961);
INSERT INTO `xoops_newblocks` VALUES (6, 1, 6, '320|190|s_poweredby.gif|1', 'Site Info', 'Site Info', '', 0, 0, 0, 'S', 'H', 1, 'system', 'system_blocks.php', 'b_system_info_show', 'b_system_info_edit', 'system_block_siteinfo.html', 0, 1198158961);
INSERT INTO `xoops_newblocks` VALUES (7, 1, 7, '', 'Who''s Online', 'Who''s Online', '', 0, 0, 0, 'S', 'H', 1, 'system', 'system_blocks.php', 'b_system_online_show', '', 'system_block_online.html', 0, 1198158961);
INSERT INTO `xoops_newblocks` VALUES (8, 1, 8, '10|1', 'Top Posters', 'Top Posters', '', 0, 0, 0, 'S', 'H', 1, 'system', 'system_blocks.php', 'b_system_topposters_show', 'b_system_topposters_edit', 'system_block_topusers.html', 0, 1198158961);
INSERT INTO `xoops_newblocks` VALUES (9, 1, 9, '10|1', 'New Members', 'New Members', '', 0, 0, 0, 'S', 'H', 1, 'system', 'system_blocks.php', 'b_system_newmembers_show', 'b_system_newmembers_edit', 'system_block_newusers.html', 0, 1198158961);
INSERT INTO `xoops_newblocks` VALUES (10, 1, 10, '10', 'Recent Comments', 'Recent Comments', '', 0, 0, 0, 'S', 'H', 1, 'system', 'system_blocks.php', 'b_system_comments_show', 'b_system_comments_edit', 'system_block_comments.html', 0, 1198158961);
INSERT INTO `xoops_newblocks` VALUES (11, 1, 11, '', 'Notification Options', 'Notification Options', '', 0, 0, 0, 'S', 'H', 1, 'system', 'system_blocks.php', 'b_system_notification_show', '', 'system_block_notification.html', 0, 1198158961);
INSERT INTO `xoops_newblocks` VALUES (12, 1, 12, '0|80', 'Themes', 'Themes', '', 0, 0, 0, 'S', 'H', 1, 'system', 'system_blocks.php', 'b_system_themes_show', 'b_system_themes_edit', 'system_block_themes.html', 0, 1198158961);
...
INSERT INTO `xoops_session` VALUES ('7cabd6df1de59b39bb0ac672d70b3f03', 1198158965, '127.0.0.1', '');
...
INSERT INTO `xoops_tplfile` VALUES (1, 1, 'system', 'default', 'system_imagemanager.html', '', 1198158961, 1198158961, 'module');
INSERT INTO `xoops_tplfile` VALUES (2, 1, 'system', 'default', 'system_imagemanager2.html', '', 1198158961, 1198158961, 'module');
INSERT INTO `xoops_tplfile` VALUES (3, 1, 'system', 'default', 'system_userinfo.html', '', 1198158961, 1198158961, 'module');
INSERT INTO `xoops_tplfile` VALUES (4, 1, 'system', 'default', 'system_userform.html', '', 1198158961, 1198158961, 'module');
INSERT INTO `xoops_tplfile` VALUES (5, 1, 'system', 'default', 'system_rss.html', '', 1198158961, 1198158961, 'module');
INSERT INTO `xoops_tplfile` VALUES (6, 1, 'system', 'default', 'system_redirect.html', '', 1198158961, 1198158961, 'module');
INSERT INTO `xoops_tplfile` VALUES (7, 1, 'system', 'default', 'system_comment.html', '', 1198158961, 1198158961, 'module');
INSERT INTO `xoops_tplfile` VALUES (8, 1, 'system', 'default', 'system_comments_flat.html', '', 1198158961, 1198158961, 'module');
INSERT INTO `xoops_tplfile` VALUES (9, 1, 'system', 'default', 'system_comments_thread.html', '', 1198158961, 1198158961, 'module');
INSERT INTO `xoops_tplfile` VALUES (10, 1, 'system', 'default', 'system_comments_nest.html', '', 1198158961, 1198158961, 'module');
INSERT INTO `xoops_tplfile` VALUES (11, 1, 'system', 'default', 'system_siteclosed.html', '', 1198158961, 1198158961, 'module');
INSERT INTO `xoops_tplfile` VALUES (12, 1, 'system', 'default', 'system_dummy.html', 'Dummy template file for holding non-template contents. This should not be edited.', 1198158961, 1198158961, 'module');
INSERT INTO `xoops_tplfile` VALUES (13, 1, 'system', 'default', 'system_notification_list.html', '', 1198158961, 1198158961, 'module');
INSERT INTO `xoops_tplfile` VALUES (14, 1, 'system', 'default', 'system_notification_select.html', '', 1198158961, 1198158961, 'module');
INSERT INTO `xoops_tplfile` VALUES (15, 1, 'system', 'default', 'system_block_dummy.html', 'Dummy template for custom blocks or blocks without templates', 1198158961, 1198158961, 'module');
INSERT INTO `xoops_tplfile` VALUES (16, 1, 'system', 'default', 'system_block_user.html', 'Shows user block', 1198158961, 1198158961, 'block');
INSERT INTO `xoops_tplfile` VALUES (17, 2, 'system', 'default', 'system_block_login.html', 'Shows login form', 1198158961, 1198158961, 'block');
INSERT INTO `xoops_tplfile` VALUES (18, 3, 'system', 'default', 'system_block_search.html', 'Shows search form block', 1198158961, 1198158961, 'block');
INSERT INTO `xoops_tplfile` VALUES (19, 4, 'system', 'default', 'system_block_waiting.html', 'Shows contents waiting for approval', 1198158961, 1198158961, 'block');
INSERT INTO `xoops_tplfile` VALUES (20, 5, 'system', 'default', 'system_block_mainmenu.html', 'Shows the main navigation menu of the site', 1198158961, 1198158961, 'block');
INSERT INTO `xoops_tplfile` VALUES (21, 6, 'system', 'default', 'system_block_siteinfo.html', 'Shows basic info about the site and a link to Recommend Us pop up window', 1198158961, 1198158961, 'block');
INSERT INTO `xoops_tplfile` VALUES (22, 7, 'system', 'default', 'system_block_online.html', 'Displays users/guests currently online', 1198158961, 1198158961, 'block');
INSERT INTO `xoops_tplfile` VALUES (23, 8, 'system', 'default', 'system_block_topusers.html', 'Top posters', 1198158961, 1198158961, 'block');
INSERT INTO `xoops_tplfile` VALUES (24, 9, 'system', 'default', 'system_block_newusers.html', 'Shows most recent users', 1198158961, 1198158961, 'block');
INSERT INTO `xoops_tplfile` VALUES (25, 10, 'system', 'default', 'system_block_comments.html', 'Shows most recent comments', 1198158961, 1198158961, 'block');
INSERT INTO `xoops_tplfile` VALUES (26, 11, 'system', 'default', 'system_block_notification.html', 'Shows notification options', 1198158961, 1198158961, 'block');
INSERT INTO `xoops_tplfile` VALUES (27, 12, 'system', 'default', 'system_block_themes.html', 'Shows theme selection box', 1198158961, 1198158961, 'block');
...
INSERT INTO `xoops_tplset` VALUES (1, 'default', 'XOOPS Default Template Set', '', 1198158961);
...
INSERT INTO `xoops_users` VALUES (1, '', 'admin', 'admin@localhost.com', 'http://localhost/workspace/20171/', 'blank.gif', 1198158961, '', '', '', 1, '', '', '', '', '5f4dcc3b5aa765d61d8327deb882cf99', 0, 0, 7, 5, 'default', 0.0, 1198158961, 'thread', 0, 1, 0, '', '', '', 0);
