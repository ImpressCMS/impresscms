...
define( "_CHECKING_APPLIED", "Sprawdzenie wykonanych upgrade'ów:" );
define( "_SET_FILES_WRITABLE", "Nadaj prawa zapisu do nastêpu±cych plików zanim zaczniesz upgrade:" );
define( "_NO_NEED_UPGRADE", "Upgrade jest zbêdny. Proszê usun±æ ten folder z serwera" );
define( "_NEED_UPGRADE", "Upgrade jest potrzebny" );
define( "_PROCEED_UPGRADE", "Zrób upgrade" );
define( "_PERFORMING_UPGRADE", "Trwa upgrade %s" );

define( "_USER_LOGIN", "Logowanie" );

define( "_MANUAL_INSTRUCTIONS", "Instrukcja instalacji manualnej" );

// %s is filename
define( "_FAILED_PATCH", "Patch %s nieudany" );
define( "_APPLY_NEXT", "WYkonaj nastêpny upgrade (%s)" );
define( "_COPY_RED_LINES", "Skopiuj czerwone linie do %s" );

define( "_FINISH", "Zakoñcz" );
define( "_RELOAD", "Od¶wie¿" );
