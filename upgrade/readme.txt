...
2. Delete local htdocs/mainfile.php, htdocs/install/, htdocs/cache/, htdocs/template_c/ from the ImpressCMS1.x package that you just downloaded (not from your server). 
3. Upload the content of the local htdocs folder over your existing files. 
4. Ensure the server can write to mainfile.php 
5. Access <your.site.url>/upgrade/ with a browser. 
6. Follow the instructions to update your database. 
7. Write-protect mainfile.php again. 
8. Delete the upgrade folder. 
...
1. Move the "upgrade" folder inside the "htdocs" folder (it's been kept out as it's not needed for full installs). 
2. Delete htdocs/mainfile.php, htdocs/install/, htdocs/cache/, htdocs/template_c/ from the ImpressCMS1.x package that you just downloaded (not from your server). 
3. Upload the content of the local htdocs folder over your existing files. 
